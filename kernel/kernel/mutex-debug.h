...
#ifdef CONFIG_PANIC_ON_DEBUG_MUTEXES    
#define MUTEX_PANIC()   panic("Please check this mutex bug warning! if it is okay, disable CONFIG_PANIC_ON_DEBUG_MUTEXES and ignore this warning!\n");   
#else
#define MUTEX_PANIC()   do{}while(0);
#endif  
