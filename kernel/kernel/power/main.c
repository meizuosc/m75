...
extern ssize_t power_mode_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf);
extern ssize_t power_mode_store(struct kobject *kobj, struct attribute *attr,const char *buf, size_t count);
