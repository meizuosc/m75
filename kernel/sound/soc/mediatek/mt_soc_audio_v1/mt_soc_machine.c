                                     ...
                                     size_t count, loff_t *pos)
{
    ...
    char buffer[size];
    int n = 0;
    pr_debug("mt_soc_ana_debug_read count = %d\n", count);
    AudDrv_Clk_On();
    audckbufEnable(true);
                                  ...
                                  size_t count, loff_t *offset)
{
    ...
    {
        pr_debug("copy_from_user mt_soc_debug_write count = %d temp = %s\n", count, InputString);
    }
    temp = kstrdup(InputString, GFP_KERNEL);
    pr_debug("copy_from_user mt_soc_debug_write count = %d temp = %s pointer = %p\n", count, InputString, InputString);
...
static struct snd_soc_dai_link mt_soc_dai_common[] =
{
    ...
    {
        .name = "ADC2_AWB_CAPTURE",
        .stream_name = MT_SOC_ADC2AWB_STREAM_NAME,
        .cpu_dai_name   = MT_SOC_ADC2AWBDAI_NAME,
        .platform_name  = MT_SOC_ADC2_AWB_PCM,
        .codec_dai_name = MT_SOC_CODEC_ADC2AWB_DUMMY_DAI_NAME,
        .codec_name = MT_SOC_CODEC_DUMMY_NAME,
        .init = mt_soc_audio_init,
        .ops = &mt_machine_audio_ops,
    },
    ...
    {
        .name = "IO2_DAI_CAPTURE",
        .stream_name = MT_SOC_IO2DAI_STREAM_NAME,
        .cpu_dai_name   = MT_SOC_IO2DAIDAI_NAME,
        .platform_name  = MT_SOC_IO2_DAI_PCM,
        .codec_dai_name = MT_SOC_CODEC_IO2DAI_DUMMY_DAI_NAME,
        .codec_name = MT_SOC_CODEC_DUMMY_NAME,
        .init = mt_soc_audio_init,
        .ops = &mt_machine_audio_ops,
    },
