...
static struct snd_soc_dai_driver dummy_6323_dai_codecs[] =
{
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_PCM2_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_PCM2_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_PCM1_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_PCM1_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_VOICE_EXTINT_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
        ...
        .capture = {
            .stream_name = MT_SOC_VOICE_EXTINT_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SNDRV_PCM_FMTBIT_S16_LE,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_ROUTING_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
        ...
        .capture = {
            .stream_name = MT_SOC_ROUTING_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_HDMI_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_HDMI_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_I2S0_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
        ...
        .capture = {
            .stream_name = MT_SOC_I2S0_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_MRGRX_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_MRGRX_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = SND_SOC_ADV_MT_FMTS,
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_MODADCI2S_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
        ...
        .capture = {
            .stream_name = MT_SOC_MODADCI2S_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
    ...
    },
    {
        ...
        .playback = {
            .stream_name = MT_SOC_ADC2AWB_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
        ...
        .capture = {
            .stream_name = MT_SOC_ADC2AWB_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
...

    {
        ...
        .playback = {
            .stream_name = MT_SOC_IO2DAI_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
        ...
        .capture = {
            .stream_name = MT_SOC_IO2DAI_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 8,
            .rates = SNDRV_PCM_RATE_8000_192000,
            .formats = (SNDRV_PCM_FMTBIT_U8 | SNDRV_PCM_FMTBIT_S8 |
