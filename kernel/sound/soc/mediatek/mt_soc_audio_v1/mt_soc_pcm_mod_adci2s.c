...
{
    //pr_debug("mtk_mod_adci2s_pcm_prepare substream->rate = %d  substream->channels = %d \n", substream->runtime->rate, substream->runtime->channels);
    return 0;
}
                                        ...
                                        struct snd_pcm_hw_params *hw_params)
{
    ...
    pr_debug("mtk_mod_adci2s_pcm_hw_params dma_bytes = %d dma_area = %p dma_addr = 0x%x\n",
...
static int mtk_mod_adci2s_pcm_open(struct snd_pcm_substream *substream)
{
    ...
    {
        pr_debug("SNDRV_PCM_STREAM_CAPTURE mtkalsa_mod_adci2s_constraints\n");
    }
    else
    {
...
static u64 mod_adci2s_pcm_dmamask = DMA_BIT_MASK(32);
...
static int mtk_asoc_mod_adci2s_pcm_new(struct snd_soc_pcm_runtime *rtd)
{
    ...
    {
        card->dev->dma_mask = &mod_adci2s_pcm_dmamask;
    }
