...
static struct snd_soc_dai_driver mtk_6331_dai_codecs[] =
{
    ...
    },
    {
        ...
        .ops = &mt6323_aif1_dai_ops,
        .playback = {
            .stream_name = MT_SOC_ULDLLOOPBACK_STREAM_NAME" RX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
        ...
        .capture = {
            .stream_name = MT_SOC_ULDLLOOPBACK_STREAM_NAME" TX",
            .channels_min = 1,
            .channels_max = 2,
            .rates = SNDRV_PCM_RATE_8000_48000,
            .formats = SND_SOC_ADV_MT_FMTS,
...
int Audio_AuxAdcData_Get_ext(void)
{
    ...
    // else
    pr_debug("vibspk auxadc- : dMax = %d dRecReadIndex [%d] dValidCount [%d] dCheckCount [%d]\n", dMax, dRecReadIndex, dValidCount, dCheckCount);
#if 0//0519
    Ana_Set_Reg(0x80be, 0x02, 0x02);
    Ana_Set_Reg(0x80c0, 0x02, 0x02);
...
{
    pr_debug("%s DAC_LOOP_DAC_HP_flag = %d DAC_LOOP_DAC_HP_flag = %d \n", __func__, DAC_LOOP_DAC_HP_flag, DAC_LOOP_DAC_HP_flag);
