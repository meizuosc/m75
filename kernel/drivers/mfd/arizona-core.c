...
int arizona_dev_init(struct arizona *arizona)
{
...
#ifdef CONFIG_ARCH_MT6595
		mt_set_gpio_out(arizona->pdata.reset, 0);
#else
	...
	if (arizona->pdata.reset) {
#ifdef CONFIG_ARCH_MT6595
		mt_set_gpio_out(arizona->pdata.reset, 1);
#else
	...
	global_arizona = arizona; /* used by MT interrupt handler */
