...
static const short AKM09911_ST_Lower[3] = {-50, -50, -400}; 
static const short AKM09911_ST_Upper[3] = {50, 50, -100};  //rocky
...
*/
	...
	if (COMPASS_ID_AK8975 == st->plat_data.sec_slave_id) {
		...
		st->slave_compass->st_upper = AKM09911_ST_Upper; //rocky 
		st->slave_compass->st_lower = AKM09911_ST_Lower; //rocky
		data[0] = DATA_AKM_MODE_SM;
	}  else if (COMPASS_ID_AK09912 == st->plat_data.sec_slave_id) {
