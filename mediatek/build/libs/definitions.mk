...
$(strip \
    ...
    $(call emit-line.mtk,$(wordlist 5601,5800,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 5801,6000,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 6001,6200,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 6201,6400,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 6401,6600,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 6601,6800,$(1)),$(2)) \
    $(call emit-line.mtk,$(wordlist 6801,7000,$(1)),$(2)) \
    $(if $(wordlist 7001,7002,$(1)),$(error Too many words ($(words $(1))))) \
 )
endef
