...
#define LOG_INF(format, args...)    xlog_printk(ANDROID_LOG_DEBUG  , "ISP", "[%s] " format, __FUNCTION__, ##args)
...
static MINT32 ISP_DumpReg(void)
{
    ...
    LOG_DBG("0x%08X %08X (0x15004160=6000)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x7000 );
    LOG_DBG("0x%08X %08X (0x15004160=7000)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x8000 );
    LOG_DBG("0x%08X %08X (0x15004160=8000)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    //imgi_debug
    LOG_DBG("IMGI_DEBUG Related");
    ISP_WR32( IMGSYS_BASE + 0x75f4, 0x001e );
    LOG_DBG("0x%08X %08X (0x150075f4=001e)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x75f4, 0x011e );
    LOG_DBG("0x%08X %08X (0x150075f4=011e)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x75f4, 0x021e );
    LOG_DBG("0x%08X %08X (0x150075f4=021e)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x75f4, 0x031e );
    LOG_DBG("0x%08X %08X (0x150075f4=031e)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    //yuv
    LOG_DBG("yuv-mdp crop Related");
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x3014 );
    LOG_DBG("0x%08X %08X (0x15004160=3014)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    LOG_DBG("yuv-c24b out Related");
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x301e );
    LOG_DBG("0x%08X %08X (0x15004160=301e)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x301f );
    LOG_DBG("0x%08X %08X (0x15004160=301f)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x3020 );
    LOG_DBG("0x%08X %08X (0x15004160=3020)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
    ISP_WR32( IMGSYS_BASE + 0x4160, 0x3021 );
    LOG_DBG("0x%08X %08X (0x15004160=3021)", (unsigned int)(IMGSYS_BASE + 0x4164), (unsigned int)ISP_RD32(IMGSYS_BASE + 0x4164));
...
static MINT32 ISP_SOF_Buf_Get(eISPIrq irqT,unsigned long long sec,unsigned long usec,MBOOL bDrop)
{
    ...
    if(g1stSof[irqT]){
        if(g1stErrhandle[ch_imgo] == MTRUE){
            ...
            pstRTBuf->ring_buf[ch_imgo].start = (pstRTBuf->ring_buf[ch_imgo].start + 1)%pstRTBuf->ring_buf[ch_imgo].total_count;
        }
        if(g1stErrhandle[ch_rrzo] == MTRUE){
            g1stErrhandle[ch_rrzo] = MFALSE;
            pstRTBuf->ring_buf[ch_rrzo].start = (pstRTBuf->ring_buf[ch_rrzo].start + 1)%pstRTBuf->ring_buf[ch_rrzo].total_count;
        }
        g1stSof[irqT] = MFALSE;
    }
    //frame time profile
...
static MINT32 ISP_CAMSV_SOF_Buf_Get(unsigned int dma,unsigned long long sec,unsigned long usec,MBOOL bDrop)
{
    ...
    if(g1stSof[irqT]){
        if(g1stErrhandle[dma] == MTRUE){
            ...
            pstRTBuf->ring_buf[dma].start = (pstRTBuf->ring_buf[dma].start + 1)%pstRTBuf->ring_buf[dma].total_count;
        }
        g1stSof[irqT] = MFALSE;
    }
    ...
    void*   DeviceId)
{
    ...
    if( IrqStatus_CAMSV & ISP_IRQ_CAMSV_STATUS_TG_SOF1_ST) {
        ...
        if((fbc.Bits.FB_NUM == fbc.Bits.FBC_CNT)&& (g1stErrhandle[_camsv_imgo_] == MFALSE)){
            gSof_camsvdone[0] = 1;
    ...
    void*   DeviceId)
{
    ...
    if(IrqStatus_CAMSV2 & ISP_IRQ_CAMSV2_STATUS_PASS1_DON_ST){
        if(IspInfo.DebugMask & ISP_DBG_INT) {
            IRQ_LOG_KEEPER(_CAMSV_D_IRQ,m_CurrentPPB,_LOG_INF,CAMSV2_TAG"fbc(0x%x)",fbc.Reg_val);
...
//    LOG_DBG("- E.");
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT_P1_ST] & ISP_IRQ_P1_STATUS_PASS1_DON_ST)
    {
        ...
        if(IspInfo.DebugMask & ISP_DBG_INT) {
            IRQ_LOG_KEEPER(_IRQ,m_CurrentPPB,_LOG_INF,"P1_DON_%d(0x%x,0x%x)\n",(sof_count[_PASS1])?(sof_count[_PASS1]-1):(sof_count[_PASS1]),p1_fbc[0].Reg_val, \
                                                 p1_fbc[1].Reg_val);
        }
#else
    #if defined(_rtbc_use_cq0c_)
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT_P1_ST] & ISP_IRQ_P1_STATUS_SOF1_INT_ST)
    {
        ...
        if((p1_fbc[_dmaport].Bits.FB_NUM == p1_fbc[_dmaport].Bits.FBC_CNT) && (g1stErrhandle[_imgo_] == MFALSE) && (g1stErrhandle[_rrzo_] == MFALSE) ){
            sof_pass1done[0] = 1;
            #ifdef _rtbc_buf_que_2_0_
    ...
    {
        if(IspInfo.DebugMask & ISP_DBG_INT) {
            IRQ_LOG_KEEPER(_IRQ_D,m_CurrentPPB,_LOG_INF,"P1_D_DON_%d_%d(0x%x,0x%x)\n",(sof_count[_PASS1_D])?(sof_count[_PASS1_D]-1):(sof_count[_PASS1_D]),d_cur_v_cnt,p1_fbc[2].Reg_val, \
                                                 p1_fbc[3].Reg_val);
        }
#ifdef _rtbc_buf_que_2_0_
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT_P1_ST_D] & ISP_IRQ_P1_STATUS_D_SOF1_INT_ST)
    {
        ...
        if((p1_fbc[_dmaport].Bits.FB_NUM == p1_fbc[_dmaport].Bits.FBC_CNT) && (g1stErrhandle[_imgo_d_] == MFALSE) && (g1stErrhandle[_rrzo_d_] == MFALSE) ){
            sof_pass1done[1] = 1;
            #ifdef _rtbc_buf_que_2_0_
