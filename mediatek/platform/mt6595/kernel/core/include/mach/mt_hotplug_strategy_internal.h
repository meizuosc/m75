...
#define HPS_TIMER_INTERVAL_MS               (300)  //default 200.
 ...
 * CONFIG - runtime
 */
#define DEF_CPU_UP_THRESHOLD                (85)    //default 80, modify for camera record
#define DEF_CPU_UP_TIMES                    (1)
#define DEF_CPU_DOWN_THRESHOLD              (70)
#define DEF_CPU_DOWN_TIMES                  (5)     //default 10. fit for HPS_TIMER_INTERVAL_MS = 300
