...
#define MSDC1_GPIO_DAT1_BASE                  (GPIO_BASE + 0xD20)
#define MSDC1_GPIO_MODE0_BASE                 (GPIO_BASE + 0x820)
#define MSDC1_GPIO_MODE1_BASE                 (GPIO_BASE + 0x830)
...
#define MSDC2_GPIO_DAT1_BASE                  (GPIO_BASE + 0xD30)
#define MSDC2_GPIO_MODE0_BASE                 (GPIO_BASE + 0x740)
#define MSDC2_GPIO_MODE1_BASE                 (GPIO_BASE + 0x750)
...
#define MSDC3_GPIO_DAT1_BASE                  (GPIO_BASE + 0xD40)
#define MSDC3_GPIO_MODE0_BASE                 (GPIO_BASE + 0x640)
#define MSDC3_GPIO_MODE1_BASE                 (GPIO_BASE + 0x650)
