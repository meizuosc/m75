#ifndef _MT6593_M4U_REG_H__
#define _MT6593_M4U_REG_H__
...
#define REG_MMU_INT_MAIN_CONTROL    0x124
    ...
    #define F_INT_TLB_MISS_FAULT(MMU)                    F_BIT_SET(5+(MMU)*7)
...
#define REG_SMI_SMI_PREULTRA_MASK0      (0x238+SMI_COMMON_EXT_BASE)	
#define REG_SMI_SMI_PREULTRA_MASK1      (0x23c+SMI_COMMON_EXT_BASE)	
...
{          
    mt65xx_reg_sync_writel(Val, (void*)addr);    
}
