			 ...
			 unsigned int *pmic_6332_gs, unsigned int pmic_6332_gs_len)
{
    ...
    for (i = 0; i < ap_analog_gs_len; i += 3) {
		...
		if (val1 != val2) {
			pr_debug("%s - AP ANALOG - 0x%x - 0x%x - 0x%x - 0x%x - ", \
	...
	for (i = 0; i < ap_cg_gs_len; i += 3) {
		...
		if (val1 != val2) {
			pr_debug("%s - AP CG - 0x%x - 0x%x - 0x%x - 0x%x - ", \
	...
	for (i = 0; i < ap_dcm_gs_len; i += 3) {
		...
		if (val1 != val2) {
			pr_debug("%s - AP DCM - 0x%x - 0x%x - 0x%x - 0x%x - ", \
	...
	for (i = 0; i < pmic_6331_gs_len; i += 3) {
		...
		if (val1 != val2) {
			pr_debug("%s - 6331 - 0x%x - 0x%x - 0x%x - 0x%x - ", \
	...
	for (i = 0; i < pmic_6332_gs_len; i += 3) {
		...
		if (val1 != val2) {
			pr_debug("%s - 6332 - 0x%x - 0x%x - 0x%x - 0x%x - ", \
