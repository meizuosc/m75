...
static int wmt_tm_proc_register(void)
{
    ...
    if (!wmt_tm_proc_dir) {
        ...
        entry = proc_create("wmt_tm", S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP, wmt_tm_proc_dir, &_wmt_tm_fops);
#if 0
        ...
        entry = proc_create("tm_pid", S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP, wmt_tm_proc_dir, &_tm_pid_fops);
#if 0
        ...
        entry = proc_create("wmt_val", S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP, wmt_tm_proc_dir, &_wmt_val_fops);
#if 0
        ...
        entry = proc_create("tx_thro", S_IRUGO | S_IWUSR, wmt_tm_proc_dir, &_tx_thro_fops);
#if 0
        ...
        entry = proc_create("wfd_stat", S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP, wmt_tm_proc_dir, &_wfd_stat_fops);        
#if 0
