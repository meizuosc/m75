    ...
    if (szFunction)
    {
        ...
        if (DUMP_FOR_SIM)
        {
            ...
            #endif
            {
                ...
                {
                case DV_REG_OFFSET0:
                    printk("        RISCWrite_MISC(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case VLD_REG_OFFSET0:
                    printk("        RISCWrite_VLD(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case VLD_TOP_REG_OFFSET0:
                    printk("        RISCWrite_VLD_TOP(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case MC_REG_OFFSET0:
                    printk("        RISCWrite_MC(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case AVC_MV_REG_OFFSET0:
                    printk("        RISCWrite_MV(%d, 32'h%x); /* base 0x%x , 0x%08x */\n", u4Addr>>2, u4Val,u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case RM_VDEC_PP_BASE:
                    printk("        RISCWrite_PP(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case HEVC_VLD_REG_OFFSET0:
                    printk("        RISCWrite_HEVC_VLD(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                default:
                    printk("        RISCWrite_Others( %d, %d );  //u4val = 0x%08X /* base 0x%08X */\n", u4Addr >> 2, u4Val, u4Val, u4BaseReg+VDEC_PHY_BASE );
                    break;
                }
            }            
            #ifdef REG_LOG_NEW
            else
            {
                ...
                {
                case DV_REG_OFFSET0:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_MISC(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case VLD_REG_OFFSET0:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_VLD(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case VLD_TOP_REG_OFFSET0:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_VLD_TOP(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case MC_REG_OFFSET0:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_MC(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case AVC_MV_REG_OFFSET0:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_MV(%d, 32'h%x); /* base 0x%x , 0x%08x */\n", u4Addr>>2, u4Val,u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case RM_VDEC_PP_BASE:
                    _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_PP(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                    break;
                case HEVC_VLD_REG_OFFSET0:
                     _u4RegisterLogLen[u4VDecID] += sprintf(_pucRegisterLog[u4VDecID]+_u4RegisterLogLen[u4VDecID], "        RISCWrite_HEVC_VLD(%d, 32'h%x); /* base 0x%x , 0x%x */\n", u4Addr>>2, u4Val, u4BaseReg+VDEC_PHY_BASE , u4Addr);
                     break;
                default:
        ...
        else
        {
            ...
            printk("%s(u4VDecID, 0x%08X, 0x%08X);\n", szFunction, u4Addr, u4Val, u4Val);
        }
    }
    else
    {
    ...
    if (szFunction)
    {
        if (DUMP_FOR_SIM)
        {
            ...
            #endif
            {
                ...
                {
                case DV_REG_OFFSET0:
                    printk("        RISCRead_MISC(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case VLD_REG_OFFSET0:
                    printk("        RISCRead_VLD(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case VLD_TOP_REG_OFFSET0:
                    printk("        RISCRead_VLD_TOP(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case MC_REG_OFFSET0:
                    printk("        RISCRead_MC(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case AVC_MV_REG_OFFSET0:
                    printk("        RISCRead_MV(%d); /* base 0x%x, return 0x%x , 0x%08x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case RM_VDEC_PP_BASE:
                    printk("        RISCRead_PP(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val, u4Addr);
                    break;
                case HEVC_VLD_REG_OFFSET0:
                    printk("        RISCRead_HEVC_VLD(%d); /* base 0x%x, return 0x%x , 0x%x */\n", u4Addr>>2,u4BaseReg+VDEC_PHY_BASE ,u4Val,u4Addr);
                    break;
                default:
        ...
        else
        {
            ...
            printk("%s(u4VDecID, 0x%08X); /* return 0x%08X */\n", szFunction, u4Addr, u4Val);
        }
    }
    else
    {
...
void vVDecSimDump(UINT32 u4VDecID, UINT32 u4OffsetAddr, UINT32 u4Addr, UINT32 u4Val)
{
    ...
    switch(u4OffsetAddr)
    {
     ...
     case VLD_REG_OFFSET1:
         printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_VLD + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;

     #if (CONFIG_CHIP_VER_CURR >= CONFIG_CHIP_VER_MT8580)
     case VLD_TOP_REG_OFFSET0:
     case VLD_TOP_REG_OFFSET1:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_VLD_TOP + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;
     #endif
     
        case MC_REG_OFFSET0:
        case MC_REG_OFFSET1:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_MC + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;

        #if 0
        case VDEC_CRC_REG_OFFSET0:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_CRC + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;
        #endif
            
        case DV_REG_OFFSET0:
        case DV_REG_OFFSET1:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_DV + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;
        ...
        case AVC_VLD_REG_OFFSET1:
            ...
            {
                printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_AVC_VLD + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            }
 ...
 //       case AVC_MV_REG_OFFSET1:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_AVC_MV + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;

 //       case AVC_FG_REG_OFFSET0:
 //       case AVC_FG_REG_OFFSET1:
            printk("[VDEC]RISCWrite('VDEC_FULL_ADDR_FG + 4*%d, %d );  //u4val = 0x%08X \n", u4Addr>>2, u4Val, u4Val);
            break;
    }
