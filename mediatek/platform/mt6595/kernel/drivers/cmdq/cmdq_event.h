...
DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX9_STREAM_EOF        ,61)   // DpFramework via CMDQ_IOCTL_LOCK_MUTEX
...
DECLARE_CMDQ_EVENT(CMDQ_MAX_HW_EVENT_COUNT             ,260)  // Keep this at the end of HW events

// SW Sync Tokens (Pre-defined)
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_CONFIG_DIRTY        ,261)  // Config thread notify trigger thread
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_STREAM_EOF          ,262)  // Trigger thread notify config thread
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_ESD_EOF             ,263)  // ESD check state. Trigger thread will be blocked until the check finishes.
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_CABC_EOF            ,264)  // check CABC setup finish

DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_VENC_INPUT_READY    ,270)  // Pass-2 notifies VENC frame is ready to be encoded
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_VENC_EOF            ,271)  // VENC notifies Pass-2 encoding completion so next frame may start


// SW Sync Tokens (User-defined)
DECLARE_CMDQ_EVENT(CMDQ_SYNC_TOKEN_USER_0              ,300)  // SW-defined sync token
