...
//    OV5642_write_cmos_sensor(0x350b, 0x00);
    OV5642_write_cmos_sensor(0x350b, 0x80);
    ...
    OV5642_write_cmos_sensor(0x3501, 0x07);
    OV5642_write_cmos_sensor(0x3502, 0x00);
    ...
    //PLL setting
    //pll setting, input = output
    #if 0//6MHz in , 12MHz out
    OV5642_write_cmos_sensor(0x300f, 0x06);
    OV5642_write_cmos_sensor(0x3010, 0x70);
    OV5642_write_cmos_sensor(0x3011, 0x20);
    OV5642_write_cmos_sensor(0x3012, 0x00);
    OV5642_write_cmos_sensor(0x3815, 0x02);
    OV5642_write_cmos_sensor(0x3029, 0x00);
    OV5642_write_cmos_sensor(0x3033, 0x03);
    OV5642_write_cmos_sensor(0x460c, 0x20);
	#elif 0 //24 MHz in, 12MHz out
    OV5642_write_cmos_sensor(0x300f, 0x6);
    OV5642_write_cmos_sensor(0x3010, 0x70);
    OV5642_write_cmos_sensor(0x3011, 0x10);
    ...
    #else //24 MHz in, 6MHz out
    OV5642_write_cmos_sensor(0x300f, 0x7);
    OV5642_write_cmos_sensor(0x3010, 0x70);
    OV5642_write_cmos_sensor(0x3011, 0x8);
    OV5642_write_cmos_sensor(0x3012, 0x2);
    OV5642_write_cmos_sensor(0x3815, 0x2);
    OV5642_write_cmos_sensor(0x3029, 0x0);
    OV5642_write_cmos_sensor(0x3033, 0x3);
...
UINT32 OV5642SetTestPatternMode(kal_bool bEnable)
{
    ...
    printk("[OV5642SetTestPatternMode] Test pattern enable:%d\n", bEnable);    
