...
LID_BIT VER_LID(AP_CFG_RDCL_FILE_AUDIO_ANC_LID)
AUDIO_ANC_CUSTOM_PARAM_STRUCT *CFG_FILE_SPEECH_ANC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_RDCL_FILE_AUDIO_SPEAKER_MONITOR_LID)
AUDIO_SPEAKER_MONITOR_PARAM_STRUCT *CFG_FILE_SPEAK_MONITOR_REC_TOTAL
{

};

/* custom */
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_ROOTSIGN_LID)
File_Rootsign_Struct *CFG_FILE_ROOTSIGN_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_RECOVERYLOCK_LID)
File_Recoverylock_Struct *CFG_FILE_RECOVERYLOCK_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_CALIBRATION_LID)
File_Calibration_Struct *CFG_FILE_CALIBRATION_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_ACCELERATION_LID)
File_Acceleration_Struct *CFG_FILE_ACCELERATION_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_GYROSCOPE_LID)
File_Gyroscope_Struct *CFG_FILE_GYROSCOPE_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_SHOPDEMO_TOOL_LID)
File_Shopdemo_Struct *CFG_FILE_SHOPDEMO_REC_TOTAL
{
