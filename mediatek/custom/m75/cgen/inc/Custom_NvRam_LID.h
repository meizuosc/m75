...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_RDCL_FILE_AUDIO_ANC_LID,
    AP_CFG_RDCL_FILE_AUDIO_SPEAKER_MONITOR_LID,
    AP_CFG_CUSTOM_FILE_ROOTSIGN_LID,
    AP_CFG_CUSTOM_FILE_RECOVERYLOCK_LID,
    AP_CFG_CUSTOM_FILE_CALIBRATION_LID,
    AP_CFG_CUSTOM_FILE_ACCELERATION_LID,
    AP_CFG_CUSTOM_FILE_GYROSCOPE_LID,
    AP_CFG_CUSTOM_FILE_SHOPDEMO_TOOL_LID,
...
#define AP_CFG_RDCL_FILE_AUDIOSUB_COMPFLT_LID_VERNO			"000"
#define AP_CFG_RDCL_FILE_AUDIO_MUSIC_DRC_LID_VERNO			"000"
#define AP_CFG_RDCL_FILE_AUDIO_RINGTONE_DRC_LID_VERNO			"000"

#define AP_CFG_RDCL_FILE_AUDIO_ANC_LID_VERNO			"000"

/* custom file version */
#define AP_CFG_CUSTOM_FILE_ROOTSIGN_LID_VERNO	"000"
#define AP_CFG_CUSTOM_FILE_RECOVERYLOCK_LID_VERNO	"000"
#define AP_CFG_CUSTOM_FILE_CALIBRATION_LID_VERNO	"000"
#define AP_CFG_CUSTOM_FILE_ACCELERATION_LID_VERNO	"000"
#define AP_CFG_CUSTOM_FILE_GYROSCOPE_LID_VERNO	"000"
#define AP_CFG_CUSTOM_FILE_SHOPDEMO_TOOL_LID_VERNO	"000"
