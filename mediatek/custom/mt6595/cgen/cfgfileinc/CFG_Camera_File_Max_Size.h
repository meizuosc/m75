...
#define MAXIMUM_NVRAM_CAMERA_SHADING_FILE_SIZE      (530000) //BYTE 81920--> 16000 for meta tool limitation

#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (94208) // 92K bytes
#define MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE          (25600) // 25K bytes
#define MAXIMUM_NVRAM_CAMERA_SENSOR_FILE_SIZE      (4096)
#define MAXIMUM_NVRAM_CAMERA_LENS_FILE_SIZE		   (8192)
