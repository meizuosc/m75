...
// ANDROID_LOG_DEBUG
// ANDROID_LOG_VERBOSE
#define TAG_NAME "led2s_strobe.c"
...
extern int FL_enable_6332_2(void);
extern int FL_disable_6332_2(void);
extern int FL_dim_duty_6332_2(kal_uint32 duty);
extern int FL_getPreOnTime_6332_2(int duty);
extern int FL_preOn_6332_2(void);


static int FL_Enable(void)
{
    PK_DBG("FL_Enable");
    return FL_enable_6332_2();
}

static int FL_Disable(void)
{
    return FL_disable_6332_2();
}

static int FL_dim_duty(kal_uint32 duty)
{
    return FL_dim_duty_6332_2(duty);
}
