...
#define LC898212XDIOC_G_MOTORINFO _IOR(LC898212XD_MAGIC,0,stLC898212XD_MotorInfo)

#define LC898212XDIOC_T_MOVETO _IOW(LC898212XD_MAGIC,1,unsigned long)

#define LC898212XDIOC_T_SETINFPOS _IOW(LC898212XD_MAGIC,2,unsigned long)

#define LC898212XDIOC_T_SETMACROPOS _IOW(LC898212XD_MAGIC,3,unsigned long)

#ifdef LensdrvCM3
#define LC898212XDIOC_G_MOTORMETAINFO _IOR(LC898212XD_MAGIC,4,stLC898212XD_MotorMETAInfo)
#endif

#define LC898212XDIOC_T_SETPARA _IOW(LC898212XD_MAGIC,5,unsigned long)
