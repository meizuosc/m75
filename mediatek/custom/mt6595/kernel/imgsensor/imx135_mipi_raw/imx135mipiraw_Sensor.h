...
#define IMX135MIPI_REAL_VIDEO_WIDTH             (4208-16)
#define IMX135MIPI_REAL_VIDEO_HEIGHT            (3120-16)

#define IMX135MIPI_REAL_HIGHSPEDVIDEO_WIDTH     (1280)
#define IMX135MIPI_REAL_HIGHSPEDVIDEO_HEIGHT    (720)

#define IMX135MIPI_REAL_SLIMVIDEO_WIDTH         (1280)
#define IMX135MIPI_REAL_SLIMVIDEO_HEIGHT        (720)
/* X/Y Starting point */
#define IMX135MIPI_IMAGE_SENSOR_PV_STARTX       2
#define IMX135MIPI_IMAGE_SENSOR_PV_STARTY       2   // The value must bigger or equal than 1.
#define IMX135MIPI_IMAGE_SENSOR_CAP_STARTX      (IMX135MIPI_IMAGE_SENSOR_PV_STARTX * IMAGE_SENSOR_H_DECIMATION)
#define IMX135MIPI_IMAGE_SENSOR_CAP_STARTY      (IMX135MIPI_IMAGE_SENSOR_PV_STARTY * IMAGE_SENSOR_V_DECIMATION)       // The value must bigger or equal than 1.
#define IMX135MIPI_IMAGE_SENSOR_VIDEO_STARTX    2
#define IMX135MIPI_IMAGE_SENSOR_VIDEO_STARTY    2    // The value must bigger or equal than 1.

#define IMX135MIPI_IMAGE_SENSOR_HSVIDEO_STARTX      0
#define IMX135MIPI_IMAGE_SENSOR_HSVIDEO_STARTY      0

#define IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_STARTX    0
#define IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_STARTY    0
...
#define IMX135MIPI_IMAGE_SENSOR_HIGHSPEDVIDEO_WIDTH     (IMX135MIPI_REAL_HIGHSPEDVIDEO_WIDTH )    
#define IMX135MIPI_IMAGE_SENSOR_HIGHSPEDVIDEO_HEIGHT    (IMX135MIPI_REAL_HIGHSPEDVIDEO_HEIGHT)

#define IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_WIDTH         (IMX135MIPI_REAL_SLIMVIDEO_WIDTH )    
#define IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_HEIGHT        (IMX135MIPI_REAL_SLIMVIDEO_HEIGHT)
...
#define IMX135MIPI_VIDEO_FRAME_LENGTH_LINES             (3144)
#define IMX135MIPI_HSVIDEO_LINE_LENGTH_PIXELS           (4572)
#define IMX135MIPI_HSVIDEO_FRAME_LENGTH_LINES           (786) // over 120fps
#define IMX135MIPI_SLIMVIDEO_LINE_LENGTH_PIXELS         (4572)
#define IMX135MIPI_SLIMVIDEO_FRAME_LENGTH_LINES         (1312)
...
#define IMAGE_SENSOR_HSVIDEO_WIDTH      IMX135MIPI_IMAGE_SENSOR_HIGHSPEDVIDEO_WIDTH
#define IMAGE_SENSOR_HSVIDEO_HEIGHT     IMX135MIPI_IMAGE_SENSOR_HIGHSPEDVIDEO_HEIGHT

#define IMAGE_SENSOR_SLIMVIDEO_WIDTH    IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_WIDTH
#define IMAGE_SENSOR_SLIMVIDEO_HEIGHT   IMX135MIPI_IMAGE_SENSOR_SLIMVIDEO_HEIGHT
...
struct IMX135MIPI_sensor_STRUCT
{
    ...
    kal_uint32  highspeedvideo_pclk;//Video1 Pclk
    kal_uint32  slimvideo_pclk;     //Video2 Pclk
    ...
    kal_uint32  hsvideo_line_length;
    kal_uint32  hsvideo_frame_length;
    kal_uint32  slimvideo_line_length;
    kal_uint32  slimvideo_frame_length;
    ...
    kal_uint16  hsvideo_dummy_pixels;   //Dummy Pixels:must be 12s
    kal_uint16  hsvideo_dummy_lines;    //Dummy Lines
    kal_uint16  slimvideo_dummy_pixels; //Dummy Pixels:must be 12s
    kal_uint16  slimvideo_dummy_lines;  //Dummy Lines
