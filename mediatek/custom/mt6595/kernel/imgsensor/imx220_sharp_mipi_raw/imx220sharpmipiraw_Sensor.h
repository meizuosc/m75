 ...
 *
 ****************************************************************************/
#ifndef _IMX220SHARPMIPI_SENSOR_H
#define _IMX220SHARPMIPI_SENSOR_H
...
typedef enum{
	...
	IMGSENSOR_MODE_ZSD_CAPTURE,
	IMGSENSOR_MODE_SLIM_CAPTURE,
	IMGSENSOR_MODE_4K_VIDEO,
...
typedef struct imgsensor_info_struct { 
	...
	imgsensor_mode_struct zsd;		//zsd scenario relative information
	imgsensor_mode_struct cap;		//capture scenario relative information
	imgsensor_mode_struct slim_cap;		//slim capture scenario relative information
	...
	imgsensor_mode_struct hd_4k_video;//4k video  scenario relative information
	...
	kal_uint8  zsd_delay_frame;		//enter capture delay frame num
	kal_uint8  slim_cap_delay_frame;		//enter capture delay frame num
	kal_uint8  pre_delay_frame;		//enter preview delay frame num
	kal_uint8  hd_4k_video_delay_frame;	//enter 4k video delay frame num
