...
//	return;
   ...
   if (!ishutter) ishutter = 1; /* avoid 0 */
    ...
    else if (OV16825_sensor.highspeedvideo_mode== KAL_TRUE) 
     {
        frame_height = OV16825_VIDEO1_PERIOD_LINE_NUMS + OV16825_sensor.dummy_lines;
     } 
    else if (OV16825_sensor.slimvideo_mode== KAL_TRUE) 
     {
        frame_height = OV16825_VIDEO2_PERIOD_LINE_NUMS + OV16825_sensor.dummy_lines;
     } 
    else{
...
//return;
    ...
    switch (ov16825CurrentScenarioId)
    {
		...
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
            line_length = OV16825_VIDEO1_PERIOD_PIXEL_NUMS + iPixels;
            frame_height = OV16825_VIDEO1_PERIOD_LINE_NUMS + iLines;
            break;
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
            line_length = OV16825_VIDEO2_PERIOD_PIXEL_NUMS + iPixels;
            frame_height = OV16825_VIDEO2_PERIOD_LINE_NUMS + iLines;
            break;	
...
static void OV16825MIPI_Sensor_video(void) 
{
	SENSORDB("OV16825MIPI max video at 30fps \n");


	/*	@@ MIPI 4-Lane 3840x2160 10-bit 30fps 800Mbps/lane
	;HTS (R380c,380d) = 0x4c0 = 1216
	;VTS (R380e,380f)=0x892 = 2194
	;;PCLK=HTS*VTS*fps=0x4c0*0x892*30=1216*2194*30=80M
	...
	; 3840x2160  4 lane	setting
	; Mipi: 4 lane
	; width		:3840 (0xF00)
	; height		:2160 (0x870) 
	HTS = 0x4c0* 4 = 0x1300 = 4864
	VTS = 0x892 = 2194		
	; Tline 	:15.2us
     ; Max exp line:(VTS-8)
      */	
    ...
    OV16825_write_cmos_sensor(0x0302,0x64);
    ...
    OV16825_write_cmos_sensor(0x3801,0xa0);
    OV16825_write_cmos_sensor(0x3802,0x02);
    OV16825_write_cmos_sensor(0x3803,0x96);
    OV16825_write_cmos_sensor(0x3804,0x10);
    OV16825_write_cmos_sensor(0x3805,0xbf);
    OV16825_write_cmos_sensor(0x3806,0x0b);
    OV16825_write_cmos_sensor(0x3807,0x0b);
    OV16825_write_cmos_sensor(0x3808,0x0f);
    OV16825_write_cmos_sensor(0x3809,0x00);
    OV16825_write_cmos_sensor(0x380a,0x08);
    OV16825_write_cmos_sensor(0x380b,0x70);
    OV16825_write_cmos_sensor(0x380c,0x04);
    OV16825_write_cmos_sensor(0x380d,0xc0);
    OV16825_write_cmos_sensor(0x380e,0x08);
    OV16825_write_cmos_sensor(0x380f,0x92);
    ...
    OV16825_write_cmos_sensor(0x3501,0x88);
...
static void OV16825MIPI_Sensor_Init(void)
{
	...
	*/
	...
	OV16825_write_cmos_sensor(0x4003, 0x08);
	OV16825_write_cmos_sensor(0x4837, 0x14);
	//OV16825_write_cmos_sensor(0x4A00, 0x24);
...
/*static void OV16825MIPI_Sensor_video3(void) 
{
	SENSORDB("OV16825MIPI 1080P at 180fps \n");
    ...
    OV16825_write_cmos_sensor(0x3018,0x7a);
    OV16825_write_cmos_sensor(0x3031,0x0a);
    OV16825_write_cmos_sensor(0x3603,0x06);
    OV16825_write_cmos_sensor(0x3604,0x02);
    OV16825_write_cmos_sensor(0x360a,0x06);
    OV16825_write_cmos_sensor(0x360b,0x02);
    OV16825_write_cmos_sensor(0x360c,0x18);
    OV16825_write_cmos_sensor(0x360d,0x04);
    OV16825_write_cmos_sensor(0x3614,0x97);
    OV16825_write_cmos_sensor(0x3616,0x33);
    OV16825_write_cmos_sensor(0x3631,0x60);
    OV16825_write_cmos_sensor(0x3700,0x30);
    OV16825_write_cmos_sensor(0x3701,0x08);
    OV16825_write_cmos_sensor(0x3702,0x11);
    ...
    OV16825_write_cmos_sensor(0x372a,0x25);
    OV16825_write_cmos_sensor(0x372b,0x65);
    OV16825_write_cmos_sensor(0x372c,0x95);
    OV16825_write_cmos_sensor(0x372d,0x65);
    OV16825_write_cmos_sensor(0x372e,0x53);
    OV16825_write_cmos_sensor(0x372f,0x33);
    OV16825_write_cmos_sensor(0x3730,0x33);
    ...
    OV16825_write_cmos_sensor(0x373e,0x0b);
    OV16825_write_cmos_sensor(0x373f,0x80);
    OV16825_write_cmos_sensor(0x3800,0x01);//00
    OV16825_write_cmos_sensor(0x3801,0x80);//00
    OV16825_write_cmos_sensor(0x3802,0x02);//00
    OV16825_write_cmos_sensor(0x3803,0x8b);//06
    OV16825_write_cmos_sensor(0x3804,0x10);//12
    OV16825_write_cmos_sensor(0x3805,0xe1);//61
    OV16825_write_cmos_sensor(0x3806,0x0b);//0d
    OV16825_write_cmos_sensor(0x3807,0x12);//97
    OV16825_write_cmos_sensor(0x3808,0x05);//06
    OV16825_write_cmos_sensor(0x3809,0x00);//00
    OV16825_write_cmos_sensor(0x380a,0x02);//04
    OV16825_write_cmos_sensor(0x380b,0xd0);//80
    OV16825_write_cmos_sensor(0x380c,0x01);//02
    OV16825_write_cmos_sensor(0x380d,0xf0);//38
    OV16825_write_cmos_sensor(0x380e,0x03);//04
    OV16825_write_cmos_sensor(0x380f,0x80);//0e;96
    OV16825_write_cmos_sensor(0x3811,0x0f);//
    OV16825_write_cmos_sensor(0x3813,0x02);
    OV16825_write_cmos_sensor(0x3814,0x03);
    OV16825_write_cmos_sensor(0x3815,0x03);
    OV16825_write_cmos_sensor(0x3820,0x00);
    OV16825_write_cmos_sensor(0x3821,0x0e);
    OV16825_write_cmos_sensor(0x3829,0x00);
    OV16825_write_cmos_sensor(0x382a,0x05);
    OV16825_write_cmos_sensor(0x382b,0x01);
    OV16825_write_cmos_sensor(0x3830,0x06);
    OV16825_write_cmos_sensor(0x3f08,0x20);
    OV16825_write_cmos_sensor(0x4002,0x01);
    OV16825_write_cmos_sensor(0x4003,0x02);
    OV16825_write_cmos_sensor(0x4837,0x14);
    OV16825_write_cmos_sensor(0x3501,0x49);
...
static void OV16825MIPI_Sensor_video2(void) 
{
	
	SENSORDB("OV16825MIPI 720P at 180fps \n");
	/*	
		@@ MIPI 4-Lane 1920x1080 121fps - reduce HTS then add VTS
		;10-bit Vskip2 Hbinning2 121fps 800Mbps/lane
		;;PCLK=HTS*VTS*fps=0x1f0*0x380*180=496*896*180=80M
...
static void OV16825MIPI_Sensor_video1(void) 
{
	SENSORDB("OV16825MIPI 1080P at 120fps \n");
/*	
	@@ MIPI 4-Lane 1920x1080 121fps - reduce HTS then add VTS
	;10-bit Vskip2 Hbinning2 121fps 800Mbps/lane
	...
	OV16825_write_cmos_sensor(0x3208,0x00);
    OV16825_write_cmos_sensor(0x301a,0xfb);
    OV16825_write_cmos_sensor(0x0302,0x64);//800Mbps_lane
    ...
    OV16825_write_cmos_sensor(0x3604,0x02);
    OV16825_write_cmos_sensor(0x360a,0x02);
    OV16825_write_cmos_sensor(0x360b,0x02);
    OV16825_write_cmos_sensor(0x360c,0x12);
    OV16825_write_cmos_sensor(0x360d,0x04);
    OV16825_write_cmos_sensor(0x3614,0x77);
    OV16825_write_cmos_sensor(0x3616,0x31);
    OV16825_write_cmos_sensor(0x3631,0x40);
    OV16825_write_cmos_sensor(0x3700,0x60);
    OV16825_write_cmos_sensor(0x3701,0x10);
    OV16825_write_cmos_sensor(0x3702,0x22);
    OV16825_write_cmos_sensor(0x3703,0x40);
    OV16825_write_cmos_sensor(0x3704,0x10);
    OV16825_write_cmos_sensor(0x3705,0x01);
    OV16825_write_cmos_sensor(0x3706,0x04);
    OV16825_write_cmos_sensor(0x3708,0x40);
    OV16825_write_cmos_sensor(0x3709,0x78);
    OV16825_write_cmos_sensor(0x370a,0x02);
    OV16825_write_cmos_sensor(0x370b,0xb2);
    OV16825_write_cmos_sensor(0x370c,0x06);
    OV16825_write_cmos_sensor(0x370e,0x40);
    OV16825_write_cmos_sensor(0x370f,0x0a);
    OV16825_write_cmos_sensor(0x3710,0x30);
    OV16825_write_cmos_sensor(0x3711,0x40);
    OV16825_write_cmos_sensor(0x3714,0x31);
    OV16825_write_cmos_sensor(0x3719,0x25);
    OV16825_write_cmos_sensor(0x371b,0x05);
    OV16825_write_cmos_sensor(0x371d,0x05);
    OV16825_write_cmos_sensor(0x371e,0x11);
    OV16825_write_cmos_sensor(0x371f,0x2d);
    OV16825_write_cmos_sensor(0x3720,0x15);
    OV16825_write_cmos_sensor(0x3721,0x30);
    OV16825_write_cmos_sensor(0x3722,0x15);
    OV16825_write_cmos_sensor(0x3723,0x30);
    OV16825_write_cmos_sensor(0x3724,0x08);
    OV16825_write_cmos_sensor(0x3725,0x08);
    OV16825_write_cmos_sensor(0x3726,0x04);
    OV16825_write_cmos_sensor(0x3727,0x04);
    OV16825_write_cmos_sensor(0x3728,0x04);
    OV16825_write_cmos_sensor(0x3729,0x04);
    OV16825_write_cmos_sensor(0x372a,0x29);
    OV16825_write_cmos_sensor(0x372b,0xc9);
    OV16825_write_cmos_sensor(0x372c,0xa9);
    OV16825_write_cmos_sensor(0x372d,0xb9);
    OV16825_write_cmos_sensor(0x372e,0x95);
    OV16825_write_cmos_sensor(0x372f,0x55);
    OV16825_write_cmos_sensor(0x3730,0x55);
    OV16825_write_cmos_sensor(0x3731,0x55);
    OV16825_write_cmos_sensor(0x3732,0x05);
    OV16825_write_cmos_sensor(0x3734,0x10);
    OV16825_write_cmos_sensor(0x3739,0x05);
    OV16825_write_cmos_sensor(0x373a,0x40);
    OV16825_write_cmos_sensor(0x373b,0x18);
    OV16825_write_cmos_sensor(0x373c,0x38);
    OV16825_write_cmos_sensor(0x373e,0x15);
    OV16825_write_cmos_sensor(0x373f,0x80);
    OV16825_write_cmos_sensor(0x3800,0x01);
    ...
    OV16825_write_cmos_sensor(0x380c,0x04);
    OV16825_write_cmos_sensor(0x380d,0x20);//b6
    OV16825_write_cmos_sensor(0x380e,0x04);
    OV16825_write_cmos_sensor(0x380f,0xe0);//48
    ...
    OV16825_write_cmos_sensor(0x382b,0x01);
    OV16825_write_cmos_sensor(0x3830,0x08);
    OV16825_write_cmos_sensor(0x3f08,0x40);
    ...
    OV16825_write_cmos_sensor(0x380a,0x04);
    OV16825_write_cmos_sensor(0x380b,0x38);
    OV16825_write_cmos_sensor(0x3810,0x00);
    OV16825_write_cmos_sensor(0x3811,0x17);//;11
    OV16825_write_cmos_sensor(0x3812,0x00);
    OV16825_write_cmos_sensor(0x3813,0x02);//;04
    OV16825_write_cmos_sensor(0x4603,0x2f);//;60
    OV16825_write_cmos_sensor(0x5000,0x7f);	
        ...
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_lock(&OV16825_drv_lock);
	OV16825_sensor.highspeedvideo_mode=KAL_FALSE;
	spin_unlock(&OV16825_drv_lock);

	spin_lock(&OV16825_drv_lock);
	OV16825_sensor.slimvideo_mode=KAL_FALSE;
	spin_unlock(&OV16825_drv_lock);
...
UINT32 OV16825VIDEO1(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    kal_uint16 dummy_line;
    //kal_uint16 ret;
#ifdef OV16825_DRIVER_TRACE
    SENSORDB("OV16825VIDEO1 \n");
#endif
	 //return ERROR_NONE;

	OV16825MIPI_Sensor_video1();
	...
	spin_lock(&OV16825_drv_lock);
	OV16825_sensor.highspeedvideo_mode=KAL_TRUE;
	spin_unlock(&OV16825_drv_lock);
    ...
    OV16825_sensor.dummy_pixels = 0;
    OV16825_sensor.dummy_lines = 0;
    OV16825_sensor.line_length = OV16825_VIDEO1_PERIOD_PIXEL_NUMS;
    OV16825_sensor.frame_height = OV16825_VIDEO1_PERIOD_LINE_NUMS+ dummy_line;
    OV16825_sensor.pclk = OV16825_VIDEO1_CLK;
    spin_unlock(&OV16825_drv_lock);
...
UINT32 OV16825VIDEO2(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    kal_uint16 dummy_line;
  //  kal_uint16 ret;
#ifdef OV16825_DRIVER_TRACE
    SENSORDB("OV16825VIDEO2 \n");
#endif
	 //return ERROR_NONE;

	OV16825MIPI_Sensor_video2();
	...
	spin_lock(&OV16825_drv_lock);
	OV16825_sensor.slimvideo_mode=KAL_TRUE;
	spin_unlock(&OV16825_drv_lock);
    ...
    OV16825_sensor.dummy_pixels = 0;
    OV16825_sensor.dummy_lines = 0;
    OV16825_sensor.line_length = OV16825_VIDEO2_PERIOD_PIXEL_NUMS;
    OV16825_sensor.frame_height = OV16825_VIDEO2_PERIOD_LINE_NUMS+ dummy_line;
    OV16825_sensor.pclk = OV16825_VIDEO2_CLK;
    spin_unlock(&OV16825_drv_lock);
...
UINT32 OV16825GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorHighSpeedVideoWidth=OV16825_IMAGE_SENSOR_VIDEO1_WIDTH;
    pSensorResolution->SensorHighSpeedVideoHeight=OV16825_IMAGE_SENSOR_VIDEO1_HEIGHT;
	pSensorResolution->SensorSlimVideoWidth=OV16825_IMAGE_SENSOR_VIDEO2_WIDTH;
    pSensorResolution->SensorSlimVideoHeight=OV16825_IMAGE_SENSOR_VIDEO2_HEIGHT;
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch(ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            ...
            break;
	    case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
            pSensorInfo->SensorPreviewResolutionX=OV16825_IMAGE_SENSOR_VIDEO1_WIDTH;
            pSensorInfo->SensorPreviewResolutionY=OV16825_IMAGE_SENSOR_VIDEO1_HEIGHT;
            pSensorInfo->SensorCameraPreviewFrameRate=120;
            break;
        case MSDK_SCENARIO_ID_SLIM_VIDEO:
            pSensorInfo->SensorPreviewResolutionX=OV16825_IMAGE_SENSOR_VIDEO2_WIDTH;
            pSensorInfo->SensorPreviewResolutionY=OV16825_IMAGE_SENSOR_VIDEO2_HEIGHT;
            pSensorInfo->SensorCameraPreviewFrameRate=180;
            break;
	  case MSDK_SCENARIO_ID_CAMERA_3D_PREVIEW: //added
	  case MSDK_SCENARIO_ID_CAMERA_3D_VIDEO:
	  case MSDK_SCENARIO_ID_CAMERA_3D_CAPTURE: //added	 
    ...
    pSensorInfo->HighSpeedVideoDelayFrame = 1;
    pSensorInfo->SlimVideoDelayFrame = 1;
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch (ScenarioId)
    {
		...
		break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
            OV16825VIDEO1(pImageWindow, pSensorConfigData);
            break;
        case MSDK_SCENARIO_ID_SLIM_VIDEO:
            OV16825VIDEO2(pImageWindow, pSensorConfigData);
            break;
        case MSDK_SCENARIO_ID_CAMERA_3D_PREVIEW: //added
        case MSDK_SCENARIO_ID_CAMERA_3D_VIDEO:
        case MSDK_SCENARIO_ID_CAMERA_3D_CAPTURE: //added   
...
UINT32 OV16825SetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) 
{
    ...
    switch (scenarioId) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            ...
            frameHeight = (pclk)/frameRate/(lineLength/4);
...
UINT32 OV16825SetVideoMode(UINT16 u2FrameRate)
{
    ...
    if((300 == u2FrameRate)||(150 == u2FrameRate)||(240 == u2FrameRate))
    {
        dummy_line = (OV16825_sensor.pclk) / (u2FrameRate/10) / (OV16825_sensor.line_length/4) - OV16825_sensor.frame_height;
        if (dummy_line < 0) 
            dummy_line = 0;
#ifdef OV16825_DRIVER_TRACE
