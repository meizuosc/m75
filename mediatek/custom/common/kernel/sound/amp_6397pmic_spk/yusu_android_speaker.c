...
//#define AMP_CLASS_AB      //no use
#define AMP_CLASS_D         //no use
//#define ENABLE_2_IN_1_SPK //no use

#if !defined(AMP_CLASS_AB) && !defined(AMP_CLASS_D)
#error "MT6397 SPK AMP TYPE does not be defined!!!"
#endif
/*****************************************************************************
*                          C O N S T A N T S
******************************************************************************
...
#define SPK_WARM_UP_TIME        (0) //unit is ms
#define SPK_AMP_GAIN            (4)  //4:15dB //no use
#define RCV_AMP_GAIN            (1)  //1:-3dB //no use
#define SPK_R_ENABLE            (1)           //no use
#define SPK_L_ENABLE            (1)           //no use
/*****************************************************************************
*                         D A T A      T Y P E S
******************************************************************************
*/
