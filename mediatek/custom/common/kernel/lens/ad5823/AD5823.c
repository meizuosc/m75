...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("AD5823", 0x18)};
...
static struct i2c_client * g_pstAD5823_I2Cclient = NULL;

static dev_t g_AD5823_devno;
static struct cdev * g_pAD5823_CharDrv = NULL;
static struct class *actuator_class = NULL;

static int  g_s4AD5823_Opened = 0;
static long g_i4MotorStatus = 0;
static long g_i4Dir = 0;
static unsigned long g_u4AD5823_INF = 0;
...
inline static int getAD5823Info(__user stAD5823_MotorInfo * pstMotorInfo)
{
	...
	if (g_s4AD5823_Opened >= 1)	{stMotorInfo.bIsMotorOpen = 1;}
