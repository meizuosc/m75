...
//ifdef Flyme_EDIT   //Multimedia Camera scx@meizu.com
    MSDK_SCENARIO_ID_ZSD_PREVIEW,
    MSDK_SCENARIO_ID_SLIM_CAPTURE,
    MSDK_SCENARIO_ID_FOURK_VIDEO,
//endif  /*Flyme_EDIT */    
...
//ifdef Flyme_EDIT   //Multimedia Camera scx@meizu.com
  MUINT16 SensorZsdWidth;
  MUINT16 SensorZsdHeight;
  MUINT16 SensorCapture1Width;
  MUINT16 SensorCapture1Height;
  MUINT16 SensorVideo4kWidth;
  MUINT16 SensorVideo4kHeight;
//endif  /*Flyme_EDIT */    
...
//ifdef Flyme_EDIT   //Multimedia Camera scx@meizu.com
  MUINT32 ZsdDelayFrame;
  MUINT32 SlimCaptureDelayFrame;
  MUINT32 VideoFourkDelayFrame;
//endif  /*Flyme_EDIT */    
...
//ifdef Flyme_EDIT   //Multimedia Camera scx@meizu.com
  MUINT16 SensorGrabStartX_ZSD;        /* SENSOR_SCENARIO_ID_ZSD_PREVIEW */
  MUINT16 SensorGrabStartY_ZSD;
  MUINT16 SensorGrabStartX_CAP1;        /* SENSOR_SCENARIO_ID_SLIM_CAPTURE */
  MUINT16 SensorGrabStartY_CAP1;
  MUINT16 SensorGrabStartX_VD4k;        /* SENSOR_SCENARIO_ID_TWOK_VIDEO */
  MUINT16 SensorGrabStartY_VD4k;
//endif  /*Flyme_EDIT */    
  MUINT16 SensorDrivingCurrent;   
  MUINT8   SensorMasterClockSwitch; 
  MUINT8   AEShutDelayFrame;        /* The frame of setting shutter default 0 for TG int */
...
//ifdef Flyme_EDIT   //Multimedia Camera scx@meizu.com
	ACDK_SENSOR_OPERATION_MODE_ZSD_PREVIEW,
	ACDK_SENSOR_OPERATION_MODE_SLIM_CAPTURE,
	ACDK_SENSOR_OPERATION_MODE_FOURK_VIDEO,
//endif  /*Flyme_EDIT */    
...
typedef struct
{
    ...
    MUINT16 VC0_STATS_SIZEH;
    MUINT16 VC0_STATS_SIZEV;
    MUINT16 VC1_ID;
    MUINT16 VC1_DataType;
    MUINT16 VC1_STATS_SIZEH;
    MUINT16 VC1_STATS_SIZEV;
    MUINT16 VC2_ID;
    MUINT16 VC2_DataType;
    MUINT16 VC2_STATS_SIZEH;
    MUINT16 VC2_STATS_SIZEV;
    MUINT16 VC3_ID;
    MUINT16 VC3_DataType;
    MUINT16 VC3_STATS_SIZEH;
    MUINT16 VC3_STATS_SIZEV;
