...
typedef struct
{
	...
	#define T4K04_IMAGE_SENSOR_VDO_WIDTH 				T4K04_IMAGE_SENSOR_PV_WIDTH  
	#define T4K04_IMAGE_SENSOR_VDO_HEIGHT				T4K04_IMAGE_SENSOR_PV_HEIGHT
	...
	#define T4K04_PV_PERIOD_LINE_NUMS					0x04F0	//1264
	
	#define T4K04_VIDEO_PERIOD_PIXEL_NUMS				T4K04_PV_PERIOD_PIXEL_NUMS
	#define T4K04_VIDEO_PERIOD_LINE_NUMS				T4K04_PV_PERIOD_LINE_NUMS
	...
	#define T4K04_PREVIEW_PCLK 							(130200000)
	#define T4K04_VIDEO_PCLK							T4K04_PREVIEW_PCLK
	#define T4K04_CAPTURE_PCLK							(130200000)
