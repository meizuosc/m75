...
}S5K4ECGX_MIPI_JPG_AF_WIN_T;


#define S5K4ECGX_MIPI_JPG_AF_CALLER_WINDOW_WIDTH  320
#define S5K4ECGX_MIPI_JPG_AF_CALLER_WINDOW_HEIGHT 240
...
typedef enum {
    ...
    SENSOR_MODE_CAPTURE,
    SENSOR_MODE_VIDEO
} S5K4ECGX_MIPI_JPG_SENSOR_MODE;



struct S5K4ECGX_MIPI_JPG_sensor_struct
{
    ...
    S5K4ECGX_MIPI_JPG_SENSOR_MODE sensorMode;
    ...
    S5K4ECGX_MIPI_JPG_AF_WIN_T  orignalAfWindows;
