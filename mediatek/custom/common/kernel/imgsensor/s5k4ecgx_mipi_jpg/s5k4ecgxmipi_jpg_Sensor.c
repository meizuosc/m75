 ...
 ****************************************************************************/
  ...
  #define S5K4ECGX_MIPIJPG_MAIN_2_USE_HW_I2C
#else //MTK_NATIVE_3D_SUPPORT
  #define S5K4ECGX_MIPIJPG_MAIN_2_USE_HW_I2C

  #ifdef S5K4ECGX_MIPI_JPG_MAIN_2_USE_HW_I2C
    #define S5K4ECGX_MIPI_JPG_SUPPORT_N3D
  #endif
#endif
...
#include "s5k4ecgxmipi_jpg_Sensor.h"
#include "s5k4ecgxmipi_jpg_Camera_Sensor_para.h"
#include "s5k4ecgxmipi_jpg_CameraCustomized.h"

#define PRE_CLK 80

#define S5K4ECGX_MIPI_JPG_DEBUG
#ifdef S5K4ECGX_MIPI_JPG_DEBUG
...
#define S5K4ECGX_MIPI_JPG_AF_Enable 1
...
static kal_uint32  S5K4ECGX_MIPI_JPG_sensor_pclk = 390 * 1000000;
...
//
kal_uint8 S5K4ECGX_MIPI_JPG_sensor_write_I2C_address = S5K4ECGX_WRITE_ID;
kal_uint8 S5K4ECGX_MIPI_JPG_sensor_read_I2C_address = S5K4ECGX_READ_ID;
kal_uint8 S5K4ECGX_MIPI_JPG_sensor_socket = DUAL_CAMERA_NONE_SENSOR;
struct S5K4ECGX_MIPI_JPG_sensor_struct S5K4ECGX_Driver;
unsigned int S5K4ECGX_Preview_enabled = 0;
unsigned int s5k4ec_cap_enable = 0;

/*
unsigned short S5K4ECGX_MIPI_JPG_DEFAULT_AE_TABLE[32] =
{
...
static kal_uint16 S5K4ECGX_read_cmos_sensor(kal_uint32 addr)
{
   kal_uint16 get_byte=0;
   char puSendCmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) };
   iReadRegI2C(puSendCmd , 2, (u8*)&get_byte, 2, S5K4ECGX_MIPI_JPG_sensor_write_I2C_address);
   return ((get_byte<<8)&0xff00)|((get_byte>>8)&0x00ff);
}
...
{
   char puSendCmd[4] = {(char)(addr >> 8) , (char)(addr & 0xFF) ,(char)(para >> 8),(char)(para & 0xFF)};
   iWriteRegI2C(puSendCmd , 4,S5K4ECGX_MIPI_JPG_sensor_write_I2C_address);
   //SENSORDB("[Write]:id=0x%x, addr=0x%x, para=0x%x\r\n", S5K4ECGX_MIPI_JPG_sensor_write_I2C_address, addr, para);
}
...
static kal_uint16 S5K4ECGX_table_write_cmos_sensor(kal_uint16* para, kal_uint32 len)
{
   ...
   while(IDX < len)
   {
       ...
       {
           BLOCK_I2C_DATA_WRITE(puSendCmd , tosend, S5K4ECGX_MIPI_JPG_sensor_write_I2C_address);
           tosend = 0;
       }
   }
   return 0;
...
unsigned int
S5K4ECGX_MIPI_JPG_GetExposureTime(void)
{
...
UINT32 S5K4ECGX_MIPI_JPG_SetTestPatternMode(kal_bool bEnable)
{
    //SENSORDB("[S5K4ECGX_MIPI_JPG_SetTestPatternMode] Fail: Not Support. Test pattern enable:%d\n", bEnable);
    //output color bar
...
**    AF Control Start
***********************************************************/
void S5K4ECGX_MIPI_JPG_set_scene_mode(UINT16 para);
BOOL S5K4ECGX_MIPI_JPG_set_param_wb(UINT16 para);



static void
S5K4ECGX_MIPI_JPG_AE_Lock(void)
{
...
static void
S5K4ECGX_MIPI_JPG_AE_UnLock(void)
{
...
static void
S5K4ECGX_MIPI_JPG_AWB_Lock(void)
{
...
static void
S5K4ECGX_MIPI_JPG_AWB_UnLock(void)
{
#if 0
    S5K4ECGX_write_cmos_sensor(0x0028,0x7000);
    S5K4ECGX_write_cmos_sensor(0x002A,0x2C66);
    ...
    {
       S5K4ECGX_MIPI_JPG_set_scene_mode(S5K4ECGX_Driver.sceneMode);
    }
    else
    {
        ...
        {
            S5K4ECGX_MIPI_JPG_set_param_wb(S5K4ECYX_MIPICurrentStatus.iWB);
        }
    }
    if (!((AWB_MODE_OFF == S5K4ECYX_MIPICurrentStatus.iWB) ||
        (AWB_MODE_AUTO == S5K4ECYX_MIPICurrentStatus.iWB)))
...
static void 
S5K4ECGX_MIPI_JPG_AE_ExpCurveGain_Config(unsigned int SceneMode)
{
...
void S5K4ECGX_MIPI_JPG_AE_Rollback_Weight_Table(void)
{
    ...
    pae_table = (unsigned short *) (&S5K4ECGX_MIPI_JPG_DEFAULT_AE_TABLE[0]);
...
static void
S5K4ECGX_MIPI_JPG_AE_Dump_WeightTbl(void)
{
    //debug only, readback
    unsigned int val[32];
...
unsigned short
S5K4ECGX_MIPI_JPG_AE_Get_WeightVal(unsigned int x, unsigned int y)
{
...
static void
S5K4ECGX_MIPI_JPG_AE_Set_Window2HW(void)
{
    ...
    exposureTime = S5K4ECGX_MIPI_JPG_GetExposureTime();
    Sleep(exposureTime);
    ...
    //S5K4ECGX_MIPI_JPG_AE_Dump_WeightTbl();
    return;
}



#define S5K4ECGX_MIPI_JPG_AE_MAX_WEIGHT_VAL 0xF
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AE_Set_Window(
    ...
    unsigned int prevH)
{
    ...
    if ((x0 == x1) && (y0 == y1))
    {
        ...
        memcpy((unsigned char*)&ae_table[0][0], (unsigned char*)&S5K4ECGX_MIPI_JPG_DEFAULT_AE_TABLE[0], 64);
    ...
    if (0 == aeStateOnOriginalSet)
    {
        ...
        ae_table[y1][x1] = S5K4ECGX_MIPI_JPG_AE_MAX_WEIGHT_VAL;
   }
    ...
    S5K4ECGX_MIPI_JPG_AE_Set_Window2HW();
    //S5K4ECGX_MIPI_JPG_AE_Dump_WeightTbl();
    //SENSORDB("S5K4ECGX ~~~~S5K4ECGX_MIPI_JPG_AE_Set_Window: (%d,%d)~(%d,%d)\n",x0, y0, x1, y1);
    return S5K4ECGX_AAA_AF_STATUS_OK;
}
...
static void
S5K4ECGX_MIPI_JPG_AF_Get_Max_Num_Focus_Areas(unsigned int *pFeatureReturnPara32)
{
...
static void
S5K4ECGX_MIPI_JPG_AE_Get_Max_Num_Metering_Areas(unsigned int *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 1;
    //SENSORDB("S5K4ECGX_MIPI_JPG_AE_Get_Max_Num_Metering_Areas *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);
}

static void
S5K4ECGX_MIPI_JPG_AF_Get_Inf(unsigned int *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 0;
}

static void
S5K4ECGX_MIPI_JPG_AF_Get_Macro(unsigned int *pFeatureReturnPara32)
{
...
static void
S5K4ECGX_MIPI_JPG_AF_rollbackWinSet(void)
{
    S5K4ECGX_MIPI_JPG_AF_WIN_T  *AfWindows;
...
S5K4ECGX_MIPI_JPG_AF_Init(void)
{
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Set_Window2HW(void)
{
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Set_Window(
    unsigned int zone_addr,
    unsigned int prevW,
    unsigned int prevH)
{
    ...
    unsigned int* ptr = (unsigned int*)zone_addr;
    unsigned int srcW_maxW = S5K4ECGX_MIPI_JPG_AF_CALLER_WINDOW_WIDTH;
    unsigned int srcW_maxH = S5K4ECGX_MIPI_JPG_AF_CALLER_WINDOW_HEIGHT;
    ...
    frameTime = S5K4ECGX_MIPI_JPG_GetExposureTime();
    //frameTime = 30;
    ...
    if (S5K4ECGX_Driver.afStateOnOriginalSet)
    {
        ...
        S5K4ECGX_MIPI_JPG_AF_rollbackWinSet();
    }
    else
    {
        SENSORDB("[4EC] AF window Update New Window.......\n");
        S5K4ECGX_MIPI_JPG_AF_Set_Window2HW();
    }
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Stop(void)
{

#if 0
#if defined(S5K4ECGX_MIPI_JPG_AF_Enable)
    ...
    {
        spin_unlock(&s5k4ecgx_mipi_drv_lock);
        S5K4ECGX_MIPI_JPG_AE_UnLock();
    }
    else
    {
        spin_unlock(&s5k4ecgx_mipi_drv_lock);
    }
    SENSORDB("S5K4ECGX ~~~~S5K4ECGX_MIPI_JPG_AF_Stop---\n");
#endif
#endif
...
/*
static void
S5K4ECGX_MIPI_JPG_AF_ShowLensPosition(void)
{
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_CancelFocus(void)
{
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Start(S5K4ECGX_AF_MODE_ENUM mode)
{
    unsigned int af_status;
    unsigned int frameTime;
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Move_to(unsigned int a_u2MovePosition)//??how many bits for ov3640??
{
    return S5K4ECGX_AAA_AF_STATUS_OK;
}
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_MIPI_JPG_AF_Get_Status(unsigned int *pFeatureReturnPara32)
{
...
static void S5K4ECGX_MIPI_JPG_set_AF_infinite(kal_bool is_AF_OFF)
{
#if 0
    if(is_AF_OFF){
      S5K4ECGX_write_cmos_sensor(0x0028, 0x7000);
...
*
*************************************************************************/
static kal_uint16 S5K4ECGX_MIPI_JPG_ReadShutter(void)
{
...
void S5K4ECGX_MIPI_JPG_SetShutter(kal_uint32 iShutter)
{
#if 0
...
* LOCAL AFFECTED
*************************************************************************/
static kal_uint32 S5K4ECGX_MIPI_JPG_ReadGain(void)
{
#if 0
    kal_uint32 Reg ;
    S5K4ECGX_write_cmos_sensor(0x002C, 0x7000);
...
static void S5K4ECGX_MIPI_JPG_SetGain(kal_uint32 iGain)
{
#if 0
    kal_uint32 Reg ;
...
void S5K4ECGX_MIPI_JPG_get_exposure_gain()
{
...
void S5K4ECGX_MIPI_JPG_GetAEFlashlightInfo(UINT32 infoAddr)
{
    SENSOR_FLASHLIGHT_AE_INFO_STRUCT* pAeInfo = (SENSOR_FLASHLIGHT_AE_INFO_STRUCT*) infoAddr;
#if 0
    pAeInfo->Exposuretime = S5K4ECGX_MIPI_JPG_ReadShutter();
    pAeInfo->Gain = S5K4ECGX_MIPI_JPG_ReadGain();
    pAeInfo->u4Fno = 28;
...
static void S5K4ECGX_MIPI_JPG_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int NormBr;
...
***********************************************************/
static
void S5K4ECGX_MIPI_JPG_Config_JPEG_Capture(ACDK_SENSOR_JPEG_OUTPUT_PARA *jpeg_para)
{
...
jpegParserParseImage(unsigned char* srcBuf, unsigned int bufSize, unsigned int *eoiOffset)
{
   ...
   unsigned char  array100Zeros[100] ={0};
    ...
    SENSORDB("[4EC] jpegParserParseImage+\n");
    
    if (srcBuf == 0 || JPEG_MARKER_START_CODE != rdPtr[0] || JPEG_MARKER_SOI != rdPtr[1])
    {
...
void S5K4ECGX_MIPI_JPG_JPEG_Capture_Parser(
...
static void S5K4ECGX_MIPI_JPG_Init_Setting(void)
{
    ...
    S5K4ECGX_MIPI_JPG_sensor_pclk = MIPI_CLK0_MAX * 4000 * 2; //(reg_val * 4k * 2)
    S5K4ECGX_write_cmos_sensor(0xFCFC, 0xD000);
    ...
    // 13.AE Weight (Normal)
    //==================================================================================
    S5K4ECGX_MIPI_JPG_AE_Rollback_Weight_Table();
...
static void S5K4ECGX_MIPI_JPG_enb_preview(void)
{
...
*
*************************************************************************/
static void S5K4ECGX_MIPI_JPG_GetEvAwbRef(PSENSOR_AE_AWB_REF_STRUCT Ref)  //???
{
...
*
*************************************************************************/
static void S5K4ECGX_MIPI_JPG_GetCurAeAwbInfo(PSENSOR_AE_AWB_CUR_STRUCT Info)
{
    //Info->SensorAECur.AeCurShutter = S5K4ECGX_MIPI_JPG_ReadShutter();
    //Info->SensorAECur.AeCurGain = S5K4ECGX_MIPI_JPG_ReadGain(); /* 128 base */
    //S5K4ECGX_write_cmos_sensor(0x0028, 0x7000);
...
UINT32 S5K4ECGX_MIPI_JPG_GetSensorID(UINT32 *sensorID)
{
   int  retry = 3;
...
UINT32 S5K4ECGX_MIPI_JPG_Open(void)
{
    kal_uint32 sensor_id=0;

    SENSORDB("[Enter]:S5K4ECGX_MIPI_JPG_Open:\r\n");
    S5K4ECGX_MIPI_JPG_GetSensorID(&sensor_id);
    ...
    S5K4ECGX_MIPI_JPG_Init_Setting();
    S5K4ECGX_MIPI_JPG_enb_preview();
...
*
*************************************************************************/
UINT32 S5K4ECGX_MIPI_JPG_Close(void)
{
...
void S5K4ECGX_MIPI_JPG_GetAutoISOValue(void)
{
...
void S5K4ECGX_MIPI_JPG_GetActiveConfigNum(unsigned int *pActiveConfigNum)
{
    spin_lock(&s5k4ecgx_mipi_drv_lock);
...
void S5K4ECGX_MIPI_JPG_SetFrameRate(MSDK_SCENARIO_ID_ENUM scen, UINT16 u2FrameRate)
{
...
static void S5K4ECGX_MIPI_JPG_Preview_Mode_Setting(kal_uint8 preview_mode)
{
    ...
    {
        S5K4ECGX_MIPI_JPG_SetTestPatternMode(1);
    }
...
UINT32 S5K4ECGX_MIPI_JPG_StopPreview(void)
{
...
static void S5K4ECGX_MIPI_JPG_Capture_Mode_Setting(kal_uint8 capture_mode)
{
    ...
    S5K4ECGX_MIPI_JPG_AF_CancelFocus(); //Lock AF //Debug

    S5K4ECGX_MIPI_JPG_StopPreview();
    ...
    S5K4ECGX_MIPI_JPG_Config_JPEG_Capture(&S5K4ECGX_Driver.jpegSensorPara);
    ...
    S5K4ECGX_MIPI_JPG_GetAutoISOValue();
...
static void S5K4ECGX_MIPI_JPG_HVMirror(kal_uint8 image_mirror)
{
    /********************************************************
...
void S5K4ECGX_MIPI_JPG_SceneOffMode()
{
...
*
*************************************************************************/
static UINT32 S5K4ECGX_MIPI_JPG_Preview(
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    {
       S5K4ECGX_MIPI_JPG_Preview_Mode_Setting(S5K4EC_PREVIEW_MODE);
           ...
           (height != S5K4ECGX_IMAGE_SENSOR_PV_HEIGHT_DRV))
       {
           ...
           S5K4ECGX_MIPI_JPG_AE_Set_Window(S5K4ECGX_Driver.apAEWindows,
    ...
    {
       S5K4ECGX_MIPI_JPG_Preview_Mode_Setting(S5K4EC_VIDEO_MODE);
    }
...
static UINT32 S5K4ECGX_MIPI_JPG_Preview_ZSD(
    MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    unsigned int width, height;
    ...
    S5K4ECGX_MIPI_JPG_Preview_Mode_Setting(S5K4EC_PREVIEW_FULLSIZE_MODE); ////MODE0=10-30FPS
...
UINT32 S5K4ECGX_MIPI_JPG_Capture(
    MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    {
        S5K4ECGX_MIPI_JPG_get_exposure_gain();
    }
    ...
    //shutter = S5K4ECGX_MIPI_JPG_ReadShutter();
    //gain = S5K4ECGX_MIPI_JPG_ReadGain();
    ...
    S5K4ECGX_MIPI_JPG_Capture_Mode_Setting(0);
    ...
    if (S5K4ECGX_Driver.manualAEStart)
    {
		...
		//Sleep(S5K4ECGX_MIPI_JPG_GetExposureTime()*2);
    }
...
UINT32 S5K4ECGX_MIPI_JPG_GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
...
UINT32 S5K4ECGX_MIPI_JPG_GetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,
...
*
*************************************************************************/
BOOL S5K4ECGX_MIPI_JPG_set_param_effect(UINT16 para)
{
...
UINT32 S5K4ECGX_MIPI_JPG_Control(
    ...
    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
   ...
   switch (ScenarioId)
   {
      case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
      case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
         S5K4ECGX_MIPI_JPG_Preview(pImageWindow, pSensorConfigData);
         break;
      case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
         S5K4ECGX_MIPI_JPG_Capture(pImageWindow, pSensorConfigData);
         break;
      case MSDK_SCENARIO_ID_CAMERA_ZSD:
     S5K4ECGX_MIPI_JPG_Preview_ZSD(pImageWindow, pSensorConfigData);
         break;
      default:
         break;
   }

   //SENSORDB("[Exit]:S5K4ECGX_MIPI_JPG_Control  func\n");
   return ERROR_NONE;
} /* S5K4ECGXControl() */
...
*
*************************************************************************/
BOOL S5K4ECGX_MIPI_JPG_set_param_banding(UINT16 para)
{
...
*
*************************************************************************/
#define S5K4ECGX_MIPI_JPG_MAX_AXD_GAIN (12 << 8) //max gain = 12
#define S5K4ECGX_MIPI_JPG_MAX_EXPOSURE_TIME ( 133 * 100) // max exposure time = 133ms

//This function is optimized version for setting EV value in order to meet
BOOL S5K4ECGX_MIPI_JPG_set_param_exposure_for_HDR(UINT16 para)
{
    kal_uint32 totalGain = 0, exposureTime = 0;
    spin_lock(&s5k4ecgx_mipi_drv_lock);

    SENSORDB("[4EC] S5K4ECGX_MIPI_JPG_set_param_exposure_for_HDR\n");
  ...
  switch (para)
  {
    ...
    totalGain = (totalGain > S5K4ECGX_MIPI_JPG_MAX_AXD_GAIN) ? S5K4ECGX_MIPI_JPG_MAX_AXD_GAIN : totalGain;
    exposureTime = (exposureTime > S5K4ECGX_MIPI_JPG_MAX_EXPOSURE_TIME) ? S5K4ECGX_MIPI_JPG_MAX_EXPOSURE_TIME : exposureTime;
...
*
*************************************************************************/
BOOL S5K4ECGX_MIPI_JPG_set_param_exposure(UINT16 para)
{
   ...
   {
       spin_unlock(&s5k4ecgx_mipi_drv_lock);
       S5K4ECGX_MIPI_JPG_set_param_exposure_for_HDR(para);
       return TRUE;
   }
   spin_unlock(&s5k4ecgx_mipi_drv_lock);
...
void S5K4ECGX_MIPI_JPG_get_AEAWB_lock(UINT32 *pAElockRet32,UINT32 *pAWBlockRet32)
{
    *pAElockRet32 = 1;
    *pAWBlockRet32 = 1;
...
void S5K4ECGX_MIPI_JPG_set_brightness(UINT16 para)
{
...
void S5K4ECGX_MIPI_JPG_set_contrast(UINT16 para)
{
...
void S5K4ECGX_MIPI_JPG_set_iso(UINT16 para)
{
...
void S5K4ECGX_MIPI_JPG_set_saturation(UINT16 para)
{
...
void S5K4ECGX_MIPI_JPG_set_scene_mode(UINT16 para)
{
    ...
    S5K4ECGX_MIPI_JPG_GetActiveConfigNum(&activeConfigNum);
    spin_lock(&s5k4ecgx_mipi_drv_lock);
    ...
    {
        S5K4ECGX_MIPI_JPG_AE_ExpCurveGain_Config(para);
    }
    ...
    {
        S5K4ECGX_MIPI_JPG_SetFrameRate(S5K4ECGXCurrentScenarioId, 30);
    }
    else
    {
        ...
        //S5K4ECGX_MIPI_JPG_SetFrameRate(S5K4ECGXCurrentScenarioId, 15);
    }
    ...
    switch (para)
    {
        ...
        default:
            ...
            S5K4ECGX_MIPI_JPG_SceneOffMode(); ////MODE0=10-30FPS
            break;
    }
    return;
}
...
UINT32 S5K4ECGX_MIPI_JPG_SensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
    ...
    switch (iCmd)
    {
        case FID_SCENE_MODE:     //auto mode or night mode
            ...
            S5K4ECGX_MIPI_JPG_set_scene_mode(iPara);
            break;
        case FID_AWB_MODE:
            SENSORDB("[4EC] FID_AWB_MODE: para=%d\n", iPara);
            S5K4ECGX_MIPI_JPG_set_param_wb(iPara);
            break;
        case FID_COLOR_EFFECT:
            SENSORDB("[4EC] FID_COLOR_EFFECT para=%d\n", iPara);
            S5K4ECGX_MIPI_JPG_set_param_effect(iPara);
            break;
        case FID_AE_EV:
            SENSORDB("[4EC] FID_AE_EV para=%d\n", iPara);
            S5K4ECGX_MIPI_JPG_set_param_exposure(iPara);
            break;
        case FID_AE_FLICKER:
            SENSORDB("[4EC] FID_AE_FLICKER para=%d\n", iPara);
            S5K4ECGX_MIPI_JPG_set_param_banding(iPara);
            break;
        ...
        case FID_ISP_CONTRAST:
            ...
            S5K4ECGX_MIPI_JPG_set_contrast(iPara);
            break;
        case FID_ISP_BRIGHT:
            SENSORDB("[4EC] FID_ISP_BRIGHT:%d\n",iPara);
            S5K4ECGX_MIPI_JPG_set_brightness(iPara);
            break;
        case FID_ISP_SAT:
            SENSORDB("[4EC] FID_ISP_SAT:%d\n",iPara);
            S5K4ECGX_MIPI_JPG_set_saturation(iPara);
            break;
        case FID_AE_ISO:
            SENSORDB("[4EC] FID_AE_ISO:%d\n",iPara);
            S5K4ECGX_MIPI_JPG_set_iso(iPara);
            break;
        default:
...
void S5K4ECGX_MIPI_JPG_SetVideoMode(UINT16 u2FrameRate)
{
    ...
    S5K4ECGX_MIPI_JPG_SetFrameRate(MSDK_SCENARIO_ID_VIDEO_PREVIEW, u2FrameRate);
    return;
}


void S5K4ECGX_MIPI_JPG_GetExifInfo(UINT32 exifAddr)
{
...
void S5K4ECGX_MIPI_JPG_GetDelayInfo(UINT32 delayAddr)
{
...
UINT32 S5K4ECGX_MIPI_JPG_SetMaxFramerateByScenario(
...
#if 0
    SENSORDB("S5K4ECGX_MIPI_JPG_SetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
    switch (scenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
             pclk = S5K4ECGX_MIPI_JPG_sensor_pclk;
...
UINT32 S5K4ECGX_MIPI_JPG_GetDefaultFramerateByScenario(
...
void S5K4ECGX_MIPI_JPG_3ACtrl(ACDK_SENSOR_3A_LOCK_ENUM action)
{
   switch (action)
   {
...
UINT32 S5K4ECGX_MIPI_JPG_FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,
               UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    //SENSORDB("S5K4ECGX_MIPI_JPG_FeatureControl+++ ID=%d\n", FeatureId);
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
             ...
             *pFeatureReturnPara32 = S5K4ECGX_MIPI_JPG_sensor_pclk;
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_SET_NIGHTMODE:
             SENSORDB("[4EC] F_SET_NIGHTMODE\n");
             //S5K4ECGX_MIPI_JPG_NightMode((BOOL) *pFeatureData16);
             //PhaseOut this ID
             break;
        ...
        case SENSOR_FEATURE_SET_ESHUTTER:
             ...
             //S5K4ECGX_MIPI_JPG_SetShutter(*pFeatureData16);
             break;

        case SENSOR_FEATURE_SET_GAIN:
             SENSORDB("[4EC] F_SET_GAIN: Not Support\n");
             //S5K4ECGX_MIPI_JPG_SetGain(*pFeatureData16);
             break;

        case SENSOR_FEATURE_GET_AE_FLASHLIGHT_INFO:
             SENSORDB("[4EC] F_GET_AE_FLASHLIGHT_INFO: Not Support\n");
             //S5K4ECGX_MIPI_JPG_GetAEFlashlightInfo(*pFeatureData32);
             break;

        case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
             S5K4ECGX_MIPI_JPG_FlashTriggerCheck(pFeatureData32);
        ...
        case SENSOR_FEATURE_SET_ISP_MASTER_CLOCK_FREQ:
             ...
             //spin_lock(&s5k4ecgx_mipi_drv_lock);
             //S5K4ECGX_MIPI_JPG_isp_master_clock = *pFeatureData32;
             //spin_unlock(&s5k4ecgx_mipi_drv_lock);
             break;
        ...
        case SENSOR_FEATURE_SET_YUV_CMD:
             ...
             S5K4ECGX_MIPI_JPG_SensorSetting((FEATURE_ID)*pFeatureData32, *(pFeatureData32+1));
             break;

        case SENSOR_FEATURE_SET_YUV_3A_CMD:
             SENSORDB("[4EC] SENSOR_FEATURE_SET_YUV_3A_CMD ID:%d\n", *pFeatureData32);
             S5K4ECGX_MIPI_JPG_3ACtrl((ACDK_SENSOR_3A_LOCK_ENUM)*pFeatureData32);
             break;

        case SENSOR_FEATURE_SET_VIDEO_MODE:
             SENSORDB("[4EC] F_SET_VIDEO_MODE\n");
             S5K4ECGX_MIPI_JPG_SetVideoMode(*pFeatureData16);
             break;

        case SENSOR_FEATURE_CHECK_SENSOR_ID:
             SENSORDB("[4EC] F_CHECK_SENSOR_ID\n");
             S5K4ECGX_MIPI_JPG_GetSensorID(pFeatureReturnPara32);
             break;

        case SENSOR_FEATURE_GET_EV_AWB_REF:
             SENSORDB("[4EC] F_GET_EV_AWB_REF\n");
             S5K4ECGX_MIPI_JPG_GetEvAwbRef(*pFeatureData32);
             break;

        case SENSOR_FEATURE_GET_SHUTTER_GAIN_AWB_GAIN:
             SENSORDB("[4EC] F_GET_SHUTTER_GAIN_AWB_GAIN\n");
             S5K4ECGX_MIPI_JPG_GetCurAeAwbInfo(*pFeatureData32);
             break;

  #ifdef MIPI_INTERFACE
        case SENSOR_FEATURE_GET_EXIF_INFO:
             //SENSORDB("[4EC] F_GET_EXIF_INFO\n");
             S5K4ECGX_MIPI_JPG_GetExifInfo(*pFeatureData32);
             break;
  #endif

        case SENSOR_FEATURE_GET_DELAY_INFO:
             SENSORDB("[4EC] F_GET_DELAY_INFO\n");
             S5K4ECGX_MIPI_JPG_GetDelayInfo(*pFeatureData32);
             break;

        case SENSOR_FEATURE_SET_SLAVE_I2C_ID:
             //SENSORDB("[4EC] F_SET_SLAVE_I2C_ID:[%d]\n",*pFeatureData32);
             S5K4ECGX_MIPI_JPG_sensor_socket = *pFeatureData32;
             break;

        case SENSOR_FEATURE_SET_TEST_PATTERN:
             SENSORDB("[4EC] F_SET_TEST_PATTERN\n");
             S5K4ECGX_MIPI_JPG_SetTestPatternMode((BOOL)*pFeatureData16);
             break;

        case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
             SENSORDB("[4EC] F_SET_MAX_FRAME_RATE_BY_SCENARIO: FAIL: NOT Support\n");
             S5K4ECGX_MIPI_JPG_SetMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, *(pFeatureData32+1));
             break;

        case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
             SENSORDB("[4EC] F_GET_DEFAULT_FRAME_RATE_BY_SCENARIO\n");
             S5K4ECGX_MIPI_JPG_GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
             break;
        ...
        case SENSOR_FEATURE_MOVE_FOCUS_LENS:
             ...
             S5K4ECGX_MIPI_JPG_AF_Move_to(pFeatureReturnPara32); // not implement yet.
             break;

        case SENSOR_FEATURE_GET_AF_STATUS:
            S5K4ECGX_MIPI_JPG_AF_Get_Status(pFeatureReturnPara32);
        ...
        case SENSOR_FEATURE_SINGLE_FOCUS_MODE:
             ...
             S5K4ECGX_MIPI_JPG_AF_Start(S5K4ECGX_AF_MODE_SINGLE);
             break;

        case SENSOR_FEATURE_CONSTANT_AF:
             SENSORDB("[4EC] F_CONSTANT_AF\n");
             S5K4ECGX_MIPI_JPG_AF_Start(S5K4ECGX_AF_MODE_CONTINUOUS);
             break;

        case SENSOR_FEATURE_CANCEL_AF:
             SENSORDB("[4EC] F_CANCEL_AF\n");
             S5K4ECGX_MIPI_JPG_AF_CancelFocus();
             break;

        case SENSOR_FEATURE_GET_AF_INF:
             SENSORDB("[4EC] F_GET_AF_INF\n");
             S5K4ECGX_MIPI_JPG_AF_Get_Inf(pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AF_MACRO:
             S5K4ECGX_MIPI_JPG_AF_Get_Macro(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AF_MACRO=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
             S5K4ECGX_MIPI_JPG_AF_Get_Max_Num_Focus_Areas(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AF_MAX_NUM_FOCUS_AREAS=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
             S5K4ECGX_MIPI_JPG_AE_Get_Max_Num_Metering_Areas(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AE_MAX_NUM_METERING_AREAS=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;
        case SENSOR_FEATURE_SET_AF_WINDOW:
             SENSORDB("[4EC] F_SET_AF_WINDOW\n");
             S5K4ECGX_MIPI_JPG_AF_Set_Window(*pFeatureReturnPara32, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height);
             break;

        case SENSOR_FEATURE_SET_AE_WINDOW:
             SENSORDB("[4EC] F_SET_AE_WINDOW\n");
             S5K4ECGX_MIPI_JPG_AE_Set_Window(*pFeatureReturnPara32, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height);
             break;

        case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
             SENSORDB("[4EC] F_GET_AE_AWB_LOCK_INFO\n");
             S5K4ECGX_MIPI_JPG_get_AEAWB_lock((*pFeatureData32),*(pFeatureData32+1));
             break;
        ...
        */
        case SENSOR_FEATURE_GET_YUV_JPEG_INFO:
            SENSORDB("[4EC]GET_YUV_JPEG_INFO");
            {
               ...
               S5K4ECGX_MIPI_JPG_JPEG_Capture_Parser(jpegFileAddr, maxBufSize, &S5K4ECGX_Driver.jpegSensorInfo);
    ...
    //SENSORDB("S5K4ECGX_MIPI_JPG_FeatureControl---\n");
    return ERROR_NONE;
} /* S5K4ECGXFeatureControl() */


SENSOR_FUNCTION_STRUCT  SensorFuncS5K4ECGX_MIPI_JPG=
{
    S5K4ECGX_MIPI_JPG_Open,             // get sensor id, set initial setting to sesnor
    S5K4ECGX_MIPI_JPG_GetInfo,          // get sensor capbility,
    S5K4ECGX_MIPI_JPG_GetResolution,    // get sensor capure/preview resolution
    S5K4ECGX_MIPI_JPG_FeatureControl,   // set shutter/gain, set/read register
    S5K4ECGX_MIPI_JPG_Control,          // change mode to preview/capture/video
    S5K4ECGX_MIPI_JPG_Close             // close, do nothing currently
};
...
UINT32 S5K4ECGX_MIPI_JPG_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
  ...
  if (pfFunc!=NULL)
     *pfFunc=&SensorFuncS5K4ECGX_MIPI_JPG;
