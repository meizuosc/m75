...
#include <linux/aee.h>  // for HW_REBOOT
...
#define	mtkpasr_info(string, args...) 	mtkpasr_print(3, "[%s]:[%s][%d] "string,MTKPASR,__FUNCTION__,__LINE__,##args)
#define mtkpasr_log(string, args...)    mtkpasr_print(2, "[%s]:[%s][%d] "string,MTKPASR,__FUNCTION__,__LINE__,##args)
