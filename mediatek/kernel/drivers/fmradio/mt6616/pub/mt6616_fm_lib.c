...
#define MT6626_FM_PATCH_PATH "/system/etc/firmware/mt6626_fm_patch.bin"
#define MT6626_FM_COEFF_PATH "/system/etc/firmware/mt6626_fm_coeff.bin"
#define MT6626_FM_HWCOEFF_PATH "/system/etc/firmware/mt6626_fm_hwcoeff.bin"
#define MT6626_FM_ROM_PATH "/system/etc/firmware/mt6626_fm_rom.bin"
