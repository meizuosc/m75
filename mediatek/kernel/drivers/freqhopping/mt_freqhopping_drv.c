...
int mt_dfs_armpll(unsigned int current_freq, unsigned int target_freq){return 0;}
EXPORT_SYMBOL(mt_dfs_armpll);

int mt_dfs_mmpll(unsigned int target_freq){	return 0;}
EXPORT_SYMBOL(mt_dfs_mmpll);

int mt_dfs_vencpll(unsigned int target_freq){return 0;}
