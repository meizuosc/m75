...
{ \
    if (aucDebugModule[DBG_##_Module##_IDX] & DBG_CLASS_##_Class) { \
        if ((DBG_CLASS_##_Class == DBG_CLASS_ERROR) || (DBG_CLASS_##_Class == DBG_CLASS_WARN)) { \
            kalDbgLog(DBG_CLASS_##_Class, ("%s:%u (" #_Module " " #_Class ") ", __FUNCTION__, __LINE__)); \
        } \
...
#define DBGLOG_MEM32(_Module, _Class, _StartAddr, _Length) \
{ \
    _Module##_##_Class##_LOGFUNC(_Module, _Class, ("(" #_Module " " #_Class ") Dump \"" #_StartAddr "\" in %s", __FUNCTION__));\
