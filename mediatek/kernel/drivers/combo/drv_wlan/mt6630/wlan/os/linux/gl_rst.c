...
static void mtk_wifi_reset(
    struct work_struct *prWorkStruct
    );
    ...
    )
{
    ...
    DBGLOG(INIT, ERROR, ("Try to trigger whole-chip reset! Chip[%04X E%u] FW Ver DEC[%u.%u] HEX[%x.%x], Driver Ver[%u.%u]\n", 
        MTK_CHIP_REV, 
