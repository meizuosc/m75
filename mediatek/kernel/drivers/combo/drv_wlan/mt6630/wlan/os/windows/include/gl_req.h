...
reqQueryVendorDriverVersion (
    ...
    OUT PVOID pvQryBuf,
    IN UINT_32 u4QryBufLen,
    OUT PUINT_32 pu4QryInfoLen
    );

WLAN_STATUS
reqQueryHardwareStatus (
    IN P_GLUE_INFO_T prGlueInfo,
    OUT PVOID pvQryBuf,
    IN UINT_32 u4QryBufLen,
    OUT PUINT_32 pu4QryInfoLen
...
BOOLEAN
imageFileMapping (
    IN NDIS_STRING      rFileName,
    OUT NDIS_HANDLE*    pFileHandle,
    OUT PVOID*          ppvMapFileBuf,
    OUT PUINT_32        pu4FileLength
    );

BOOLEAN
imageFileUnMapping (
    IN NDIS_HANDLE  rFileHandle,
    OUT PVOID       pvMapFileBuf
    );
LINT_EXT_HEADER_END
