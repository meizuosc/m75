...
** [ALPS01514837] [MT6595][SQC1][KK][Free Test][SIM management][KE]Kernel (KE),0,0,99,/data/core/,0,,KE at tx_thread,after tap"SIM mamagement"(0/5)
    ...
    do {
...
#if CFG_SUPPORT_CFG_FILE
        {
            ...
            if(pucConfigBuf) {
                ...
                else if(kalReadToFile("/system/etc/firmware/wifi.cfg",
                            pucConfigBuf, WLAN_CFG_FILE_BUF_SIZE, &u4ConfigReadLen) == 0){
                }                
