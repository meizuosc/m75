...
NdisMDeregisterInterrupt(
    IN PUINT_32  Interrupt
    );

VOID
NdisWriteErrorLogEntry(
    IN UINT_32  NdisAdapterHandle,
    IN UINT_32  ErrorCode,
    IN ULONG  NumberOfErrorValues);

UINT_32
CreateEvent(
  PUINT_32 lpEventAttributes,
  BOOL bManualReset,
  BOOL bInitialState,
  PVOID lpName
);
