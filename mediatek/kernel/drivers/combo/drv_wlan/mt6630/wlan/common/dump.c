...
VOID
dumpMemory8 (
    IN UINT_32  u4DbgIndex,
    IN UINT_8   ucDbgClass,
    ...
    )
{
    ...
    DBGFUNC(u4DbgIndex, ucDbgClass, ("DUMP8 ADDRESS: %08lx, Length: %ld\n", (UINT_32)pucStartAddr, u4Length));

    while (u4Length > 0) {
        if (u4Length >= 16) {
            DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x %02x %02x %02x\n",
            ...
            switch (u4Length) {
            case 1:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0]));
                break;
            case 2:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1]));
                break;
            case 3:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2]));
                break;
            case 4:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3]));
                break;
            case 5:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4]));
                break;
            case 6:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5]));
                break;
            case 7:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6]));
                break;
            case 8:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7]));
                break;
            case 9:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                    pucStartAddr[ 8]));
                break;
            case 10:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                ...
                break;
            case 11:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                ...
                break;
            case 12:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                    pucStartAddr[ 8], pucStartAddr[ 9], pucStartAddr[10], pucStartAddr[11]));
                break;
            case 13:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                    pucStartAddr[ 8], pucStartAddr[ 9], pucStartAddr[10], pucStartAddr[11],
                ...
                break;
            case 14:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                    pucStartAddr[ 8], pucStartAddr[ 9], pucStartAddr[10], pucStartAddr[11],
                ...
                break;
            case 15:
                DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %02x %02x %02x %02x  %02x %02x %02x %02x - %02x %02x %02x %02x  %02x %02x %02x\n",
                    (UINT_32)pucStartAddr,
                    pucStartAddr[ 0], pucStartAddr[ 1], pucStartAddr[ 2], pucStartAddr[ 3],
                    pucStartAddr[ 4], pucStartAddr[ 5], pucStartAddr[ 6], pucStartAddr[ 7],
                    pucStartAddr[ 8], pucStartAddr[ 9], pucStartAddr[10], pucStartAddr[11],
    ...
    )
{
    ...
    DBGFUNC(u4DbgIndex, ucDbgClass, ("DUMP32 ADDRESS: %08lx, Length: %ld\n", (UINT_32)pu4StartAddr, u4Length));
    ...
    while (u4Length > 0) {
        if (u4Length >= 16) {
            DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx %08lx %08lx\n",
                (UINT_32)pu4StartAddr,
            ...
            case 3:
                 ...
                 break;
            case 4:
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0]));
                 break;
            case 5:
                 pucAddr = (PUINT_8) &pu4StartAddr[1];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx ------%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0],
                    pucAddr[0]));
                 break;
            case 6:
                 pucAddr = (PUINT_8) &pu4StartAddr[1];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx ----%02x%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0],
                    pucAddr[1], pucAddr[0]));
                 break;
            case 7:
                 pucAddr = (PUINT_8) &pu4StartAddr[1];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx --%02x%02x%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0],
                    pucAddr[2], pucAddr[1], pucAddr[0]));
                 break;
            case 8:
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1]));
                 break;
            case 9:
                 pucAddr = (PUINT_8) &pu4StartAddr[2];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx ------%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1],
                    pucAddr[0]));
                 break;
            case 10:
                 pucAddr = (PUINT_8) &pu4StartAddr[2];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx ----%02x%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1],
                    pucAddr[1], pucAddr[0]));
                 break;
            case 11:
                 pucAddr = (PUINT_8) &pu4StartAddr[2];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx --%02x%02x%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1],
                    pucAddr[2], pucAddr[1], pucAddr[0]));
                 break;
            case 12:
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx %08lx\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1], pu4StartAddr[2]));
                 break;
            case 13:
                 pucAddr = (PUINT_8) &pu4StartAddr[3];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx %08lx ------%02x\n",
                    (UINT_32)pu4StartAddr,
                    pu4StartAddr[0], pu4StartAddr[1], pu4StartAddr[2],
                    pucAddr[0]));
                 break;
            case 14:
                 pucAddr = (PUINT_8) &pu4StartAddr[3];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx %08lx ----%02x%02x\n",
                     (UINT_32)pu4StartAddr,
                     pu4StartAddr[0], pu4StartAddr[1], pu4StartAddr[2],
                     pucAddr[1], pucAddr[0]));
                 break;
            case 15:
                 pucAddr = (PUINT_8) &pu4StartAddr[3];
                 DBGFUNC(u4DbgIndex, ucDbgClass, ("(%08lx) %08lx %08lx %08lx --%02x%02x%02x\n",
                     (UINT_32)pu4StartAddr,
                     pu4StartAddr[0], pu4StartAddr[1], pu4StartAddr[2],
                     pucAddr[2], pucAddr[1], pucAddr[0]));
                 break;
