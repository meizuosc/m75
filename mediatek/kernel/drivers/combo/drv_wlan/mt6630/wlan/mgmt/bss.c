...
** $Log: bss.c $
**
** 08 19 2014 eason.tsai
** [ALPS01684357] hostap模式支持隐藏SSID
** 	Merging
**  	
** 	//ALPS_SW/TRUNK/KK/alps/mediatek/kernel/drivers/combo/drv_wlan/mt6630/wlan/mgmt/bss.c
**  	
** 	to //ALPS_SW/MP/KK1.MP11/alps/mediatek/kernel/drivers/combo/drv_wlan/mt6630/wlan/mgmt/bss.c
**
** 08 19 2014 eason.tsai
** [ALPS01070904] [Need Patch] [Volunteer Patch]
** .add support hidden SSID
**
