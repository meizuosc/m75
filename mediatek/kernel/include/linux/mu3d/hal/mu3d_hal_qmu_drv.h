...
EXTERN void _ex_mu3d_hal_alloc_qmu_mem(void);
EXTERN void _ex_mu3d_hal_free_qmu_mem(void);
...
//EXTERN PGPD _ex_get_gpd(USB_DIR dir,DEV_UINT32 num);
EXTERN PGPD get_gpd(USB_DIR dir,DEV_UINT32 num);

EXTERN void *_ex_gpd_phys_to_virt(void *paddr,USB_DIR dir,DEV_UINT32 num);
