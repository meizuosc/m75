...
extern void masp_secure_algo(unsigned char Direction, unsigned int ContentAddr, unsigned int ContentLen, unsigned char *CustomSeed, unsigned char *ResText);
extern unsigned char masp_secure_algo_init(void);
extern unsigned char masp_secure_algo_deinit(void);
extern int masp_ccci_signfmt_verify_file(char *file_path, unsigned int *data_offset, unsigned int *data_sec_len);
...
extern int masp_ccci_decrypt_cipherfmt(int fp_id, unsigned int start_off, char *buf, unsigned int buf_len, unsigned int *data_offset);
extern unsigned char masp_secro_en(void);
extern unsigned int masp_secro_md_len(unsigned char *md_info);
extern unsigned int masp_secro_md_get_data(unsigned char *md_info, unsigned char *buf, unsigned int offset, unsigned int len);
