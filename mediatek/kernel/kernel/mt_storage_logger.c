...
#endif
static int storage_logger_dump_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
  char tmpBuf[4];
...
static int storage_logger_bufsize_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	char tmpBuf[30];
	unsigned long u4CopySize = 0;
...
static int storage_logger_filename_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
...
static int storage_logger_iosched_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	char tmpBuf[4];
	int u4CopySize = 0;
	int tmp = 0;
...
static int storage_logger_fs_rectime_threshold_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
    char tmpBuf[30];
    unsigned long u4CopySize = 0;
    unsigned int  local_logger_bs;
...
static int storage_logger_write_proc(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	char acBuf[32]; 
	char cmd[32];
...
static int storage_logger_write_flag(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	unsigned long CopySize = 0;
